            ...
            createImageToolbox: function() {
                ...
                if ("never" != this.options.showimagetoolbox) {
                    ...
                    if ("center" == this.options.imagetoolboxstyle)
                        ...
                        a += " .html5gallery-left-" + this.id + " { position:absolute; display:" + ("show" == this.options.imagetoolboxmode ? "block" : "none") + "; cursor:pointer;padding-bottom:285px;right:38px;width:48px;height:48px;background:url('" + this.options.skinfolder + "side_prev.png') no-repeat right bottom;} ";
                        a += " .html5gallery-right-" + this.id + " { position:absolute; display:" + ("show" == this.options.imagetoolboxmode ? "block" : "none") + ";cursor:pointer;padding-bottom:285px;left:" + e + "px; width:48px;height:48px;background:url('" + this.options.skinfolder + "side_next.png')  no-repeat right bottom;} ";
