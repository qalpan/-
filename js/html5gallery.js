            ...
            createImageToolbox: function() {
                ...
                if ("never" != this.options.showimagetoolbox) {
                    ...
                    if ("center" == this.options.imagetoolboxstyle)
                        ...
                        a += " .html5gallery-left-" + this.id + " { position:absolute; display:" + ("show" == this.options.imagetoolboxmode ? "block" : "none") + "; cursor:pointer; top:" + c + "px;  right: 67px; width:48px; height:48px; background:url('" + this.options.skinfolder + "side_prev.png') no-repeat center center;} ";
