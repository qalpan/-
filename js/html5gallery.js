            ...
            createImageToolbox: function() {
                ...
                if ("never" != this.options.showimagetoolbox) {
                    ...
                    if ("center" == this.options.imagetoolboxstyle)
                        ...
                        a += " .html5gallery-left-" + this.id + " { position:absolute; display:" + ("show" == this.options.imagetoolboxmode ? "block" : "none") + "; cursor:pointer;padding-bottom:304px;right:27px;width:48px;height:48px;background:url('" + this.options.skinfolder + "side_prev.svg') no-repeat right bottom;} ";
                        a += " .html5gallery-right-" + this.id + " { position:absolute; display:" + ("show" == this.options.imagetoolboxmode ? "block" : "none") + ";cursor:pointer;padding-bottom:304px;left:" + e + "px; width:48px;height:48px;background:url('" + this.options.skinfolder + "side_next.svg')  no-repeat right bottom;} ";
