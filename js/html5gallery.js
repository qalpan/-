(function () {
    for (var u = document.getElementsByTagName("script"), s = "", m = 0; m < u.length; m++)
        u[m].src && u[m].src.match(/html5gallery\.js/i) && (s = u[m].src.substr(0, u[m].src.lastIndexOf("/") + 1));
    u = !1;
    if ("undefined" == typeof jQuery)
        ...
        u = !0;
    if (u) {
        var u = document.getElementsByTagName("head")[0], t = document.createElement("script");
        t.setAttribute("type", "text/javascript");
        t.readyState ? t.onreadystatechange = function () {
            if ("loaded" == t.readyState || "complete" == t.readyState)
                t.onreadystatechange = null, loadHtml5Gallery(s);
        } : t.onload = function () {
            loadHtml5Gallery(s);
        };
...
function loadHtml5Gallery(u) {
    ...
    jQuery.extend(jQuery.easing, { def: "easeOutQuad", easeInQuad: function (b, e, a, c, d) {
        return c * (e /= d) * e + a;
    ...
    s.fn.touchSwipe = function (b) {
        var e = { preventWebBrowser: !1, instance: null, preventWebBrowserCallback: null, swipeLeft: null, swipeRight: null, swipeTop: null, swipeBottom: null };
        b && s.extend(e, b);
        return this.each(function () {
            ...
            function b(a) {
                var c = e.preventWebBrowser, d = a.originalEvent;
            ...
            function d(a) {
                if (0 < l || 0 < g)
                    100 < Math.abs(l - f) && (l > f ? e.swipeRight && e.swipeRight.call() : e.swipeLeft && e.swipeLeft.call()), 100 < Math.abs(g - j) && (g > j ? e.swipeBottom && e.swipeBottom.call() : e.swipeTop && e.swipeTop.call());
                h(a);
            }
            function h() {
                g = l = j = f = -1;
    ...
    var t = m.event, x = t.special, k = null, k = x.drag = { defaults: { which: 1, distance: 0, not: ":input", handle: null, relative: !1, drop: !0, click: !1 }, datakey: "dragdata", livekey: "livedrag", add: function (b) {
        var e = m.data(this, k.datakey), a = b.data || {};
        e.related += 1;
        ...
        if (!m.data(this, k.datakey)) {
            var b = m.extend({ related: 0 }, k.defaults);
        ...
        return { drag: b, callback: new k.callback, droppable: [], offset: m(b)[e.relative ? "position" : "offset"]() || { top: 0, left: 0 } };
    }, handler: function (b) {
        var e = b.data;
        switch (b.type) {
            ...
            case "mouseup": t.remove(document, "mousemove mouseup", k.handler), e.dragging && (!1 !== e.drop && x.drop && x.drop.handler(b, e), k.hijack(b, "dragend", e)), k.textselect(!0), !1 === e.click && e.dragging && (jQuery.event.triggered = !0, setTimeout(function () {
        ...
        m.each(c.live || [], function (c, h) {
            if (0 === h.preType.indexOf("drag") && (a = m(b.target).closest(h.selector, b.currentTarget)[0]))
                t.add(a, h.origType + "." + k.livekey, h.origHandler, h.data), 0 > m.inArray(a, e) && e.push(a);
        });
        ...
        if (a) {
            var h = b.originalEvent, f = b.type, j = e.indexOf("drop") ? "drag" : "drop", l, g = c || 0, w, q;
            ...
            do
                if ((w = a.interactions[g]) && !("dragend" !== e && w.cancelled))
                    q = k.properties(b, a, w), w.results = [], m(d || w[j] || a.droppable).each(function (c, d) {
                        q.target = d;
    ...
    k.callback.prototype = { update: function () {
    ...
    A.fn.html5boxTransition = function (b, e, a, c, d) {
        $parent = this;
        b = c.effect;
        var h = c.easing, f = c.duration, j = c.direction, l = null;
        ...
        })) : "slide" == l ? ($parent.css({ overflow: "hidden" }), j ? (a.css({ left: "100%" }), a.animate({ left: "0%" }, f, h), e.animate({ left: "-100%" }, f, h, function () {
            e.remove();
            d();
        })) : (a.css({ left: "-100%" }), a.animate({ left: "0%" }, f, h), e.animate({ left: "100%" }, f, h, function () {
            e.remove();
            d();
        }))) : (a.show(), e.remove(), d());
    };
    ...
    n.fn.addHTML5VideoControls = function (b, e, a, c, d, h, f, j, l) {
        var g = "ontouchstart" in window, w = g ? "touchstart" : "mousedown", q = g ? "touchmove" : "mousemove", k = g ? "touchcancel" : "mouseup", m = g ? 48 : 36, t = null, u = null, s = !1, x = !0, D = n(this).data("ishd"), A = n(this).data("hd"), F = n(this).data("src"), r = n(this);
        r.get(0).removeAttribute("controls");
        var B = n("<div class='html5boxVideoPlay'></div>");
        r.after(B);
        B.css({ position: "absolute", top: "50%", left: "50%", display: "block", cursor: "pointer", width: 64, height: 64, "margin-left": -32, "margin-top": -32, "background-image": "url('" + (l && "playbutton" in l && 0 < l.playbutton.length ? l.playbutton : b + "oinatu.svg") + "')", "background-position": "center center", "background-repeat": "no-repeat" }).on("click", function () {
            r.get(0).play();
        });
        var E = n("<div class='html5boxVideoFullscreenBg'></div>"), v = n("<div class='html5boxVideoControls'><div class='html5boxVideoControlsBg'></div><div class='html5boxPlayPause'><div class='html5boxPlay'></div><div class='html5boxPause'></div></div><div class='html5boxTimeCurrent'>--:--</div><div class='html5boxFullscreen'></div><div class='html5boxHD'></div><div class='html5boxVolume'><div class='html5boxVolumeButton'></div><div class='html5boxVolumeBar'><div class='html5boxVolumeBarBg'><div class='html5boxVolumeBarActive'></div></div></div></div><div class='html5boxTimeTotal'>--:--</div><div class='html5boxSeeker'><div class='html5boxSeekerBuffer'></div><div class='html5boxSeekerPlay'></div><div class='html5boxSeekerHandler'></div></div><div style='clear:both;'></div></div>");
        r.after(v);
        r.after(E);
        E.css({ display: "none", position: "fixed", left: 0, top: 0, bottom: 0, right: 0 });
        v.css({ display: "block", position: "absolute", width: "100%", height: m, left: 0, bottom: 0, right: 0, margin: "0 auto" });
        var J = function () {
            x = !0;
        };
        ...
        C.css({ display: "block", cursor: "pointer", overflow: "hidden", position: "relative", height: "2px", "background-color": "rgba(255,193,7,0.42)",margin:Math.floor((m-2)/2) +"px 4px"}).on(w,function(a){
        ...
        if (y.get(0).requestFullscreen || y.get(0).webkitRequestFullScreen || y.get(0).mozRequestFullScreen || y.get(0).webkitEnterFullScreen || y.get(0).msRequestFullscreen) {
            var H = function (a) {
                f ? a ? (r.get(0).setAttribute("controls", "controls"), j && r.get(0).setAttribute("controlsList", "nodownload")) : r.get(0).removeAttribute("controls") : a ? (n(document).on("mousemove", J), v.css({ "z-index": 2147483647, position: "fixed" }), E.css({ "z-index": 2147483647, display: "block" }), B.css({ "z-index": 2147483647 })) : (n(document).off("mousemove", J), v.css({ "z-index": "", position: "absolute" }), E.css({ "z-index": "", display: "none" }), B.css({ "z-index": "" }));
            };
            ...
            n(".html5boxFullscreen", v).css({ display: "block", position: "relative", "float": "right", width: "32px", height: "32px", margin: Math.floor((m - 32) / 2), cursor: "pointer", "background-image": "url('" + b + "ylken-kihi-ekran.svg')", "background-position": "left top" }).hover(function () {
                ...
                var a = n(this).css("background-position") ? n(this).css("background-position").split(" ")[0] : n(this).css("background-position-x");
                n(this).css({ "background-position": a + " top" });
            }).on("click", function () {
        ...
        if (A)
            n(".html5boxHD", v).css({ display: "block", position: "relative", "float": "right", width: "32px", height: "32px", margin: Math.floor((m - 32) / 2), cursor: "pointer", "background-image": "url('" + b + "html5boxplayer_hd.png')", "background-position": (D ? "right" : "left") + " center" }).on("click", function () {
                D = !D;
                n(this).css({ "background-position": (D ? "right" : "left") + " center" });
                e.isHd = D;
        ...
        if (r.get(0).volume === a / 2 + 0.1) {
            ...
            var V = n(".html5boxVolumeButton", v), Z = n(".html5boxVolumeBar", v), K = n(".html5boxVolumeBarBg", v), Q = n(".html5boxVolumeBarActive", v);
            h.css({ display: "block", position: "relative", "float": "right", width: "32px", height: "32px", margin: Math.floor((m - 32) / 2) }).hover(function () {
                clearTimeout(u);
            ...
            V.css({ display: "block", position: "absolute", top: 0, left: 0, width: "32px", height: "32px", cursor: "pointer", "background-image": "url('" + b + "dauys.svg')", "background-position": "top " + (0 < a ? "left" : "right") }).hover(function () {
                ...
                V.css({ "background-position": (0 < a ? "left" : "right") + " " + b });
                0 < a && (r.get(0).muted = !1);
                r.get(0).volume = a;
                Q.css({ height: Math.round(100 * a) + "%" });
            });
            Z.css({ display: "none", position: "absolute", left: 4, bottom: "84%", width: 24, height: 80, "margin-bottom": Math.floor((m - 32) / 2),"background-color":"",opacity:0.7,filter:"alpha(opacity=70)"});
            K.css({ display:"block",position:"relative",width:10,height:68,margin:7,cursor:"pointer","background-color":"rgba(255, 193, 7, 0.42)"});
            ...
            K.on(w, function (a) {
                ...
                a = 1 < a ? 1 : 0 > a ? 0 : a;
                Q.css({ height: Math.round(100 * a) + "%" });
                V.css({ "background-position": "left " + (0 < a ? "top" : "bottom") });
                0 < a && (r.get(0).muted = !1);
                r.get(0).volume = a;
                K.on(q, function (a) {
                    a = 1 - ((g ? a.originalEvent.touches[0] : a).pageY - K.offset().top) / K.height();
        ...
        k = function () {
            ...
            if (a) {
                ...
                if (b) {
                    G.text(aa(b));
                    var c = C.width(), a = Math.round(c * a / b);
                    O.css({ width: a });
                    M.css({ left: a });
                }
            }
        ...
        m = function () {
            if (r.get(0).buffered && 0 < r.get(0).buffered.length && !isNaN(r.get(0).buffered.end(0)) && !isNaN(r.get(0).duration)) {
                var a = C.width();
                P.css({ width: Math.round(a * r.get(0).buffered.end(0) / r.get(0).duration) });
            }
        };
        try {
            r.on("play", function () {
    ...
    b.fn.html5gallery = function (k) {
        ...
        e.prototype = { getParams: function () {
            ...
            if (a.options.random)
                for (var c = a.elemArray.length - 1; 0 < c; c--) {
                    var d = Math.floor(Math.random() * c), h = a.elemArray[c];
            ...
            a.options.frve ? a.options.watermarkcode = "" + a.options.freelink + "" : 0 < a.options.watermarklink.length && (a.options.watermarkcode = "" + a.options.watermarklink + "");
            a.options.watermarkcode += "<div " + (a.options.frve ? "" : "" + a.id + "' ") + "style='" + (a.options.frve ? "" : 0 < a.options.watermark.length ? "" : "display:none;") + "";
            ...
            switch (this.options.skin) {
                ...
                case "showcase":
                    ...
                    break;
                default: this.resizeStyleDefault();
            }
            ...
            if (this.options.frve) {
                ...
                if (0 > a.text().indexOf(this.options.frvem) || 0 > c.length)
                    a.append("<a style='text-decoration:none;' target='_blank' href='" + this.options.freelink + "' ><div style='" + this.options.frvem + "</div></a>");
                else if (a = c.find("div"), "none" == c.css("display") || "hidden" == c.css("visibility") || 8 > parseInt(c.css("font-size")) || "none" == a.css("display") || "hidden" == a.css("visibility") || 8 > parseInt(a.css("font-size")))
                    c.attr({ style: (c.attr("style") || "") + "display:block!important;visibility:visible!important;font-size:12px!important;" }), a.attr({ style: a.attr("style") + "display:block!important;visibility:visible!important;font-size:12px!important;" });
            }
        }, initData: function (a) {
            this.elemArray = [];
            if (this.options.src && 0 < this.options.src.length) {
                ...
                var d = this;
                b.ajax({ type: "GET", url: this.options.xml, dataType: "xml", success: function (c) {
                    b(c).find("slide").each(function (a) {
                        var c = b(this).find("title").text(), h = b(this).find("description").text() ? b(this).find("description").text() : b(this).find("information").text();
                        c || (c = "");
                        h || (h = "");
            ...
            (b("img.html5galleryimg", this.container).length ? b("img.html5galleryimg", this.container) : b("img", this.container)).each(function () {
                ...
                var d = c, e = b(this).data("title") ? b(this).data("title") : b(this).attr("alt"), f = b(this).data("description") ? b(this).data("description") : b(this).data("information"), j = b(this).attr("alt") ? b(this).attr("alt") : b(this).data("title");
                e || (e = "");
                f || (f = "");
                j || (j = "");
                var l = a.options.width, g = a.options.height, w = b(this).data("duration") ? b(this).data("duration") : 0, q = null, k = null, m = null, n = null, s = null, t = null, u = null, x = null, A = null, F = null, r = null, B = null, E = null, v = !1;
                ...
                a.elemArray.push([a.elemArray.length, c, d, q, k, m, n, e, f, J, l, g, s, t, u, x, w, A, F, r, B, E, v, l, g, j]);
            });
            ...
            b.getJSON(g, function (b) {
                if (b && b.items)
                    for (var g = 0; g < b.items.length; g++) {
                        var l = b.items[g].snippet.resourceId.videoId, k = "https://img.youtube.com/vi/" + l + "/" + j.options.youtubeimage;
            ...
            if (this.options.showsocialmedia && this.options.showfacebooklike) {
                var c = "<div style='display:block; float:left; width:110px; height:21px;'><iframe src='https://www.facebook.com/plugins/like.php?href=", c = this.options.facebooklikeurl && 0 < this.options.facebooklikeurl.length ? c + encodeURIComponent(this.options.facebooklikeurl) : c + a;
            ...
            this.isFullscreen ? (a = Math.max(0, Math.floor(b(".html5gallery-fullscreen-elem-wrapper-" + this.id, this.$fullscreen).width() * a)), b(".html5gallery-fullscreen-timer-" + this.id, this.$fullscreen).css({ width: a + "px" })) : (a = Math.max(0, Math.floor(b(".html5gallery-elem-" + this.id, this.$gallery).width() * a)), b(".html5gallery-timer-" + this.id, this.$gallery).css({ width: a + "px" }));
            ...
            if (a.options.enabletouchswipe) {
                ...
                b(".html5gallery-box-" + this.id, this.$gallery).touchSwipe({ preventWebBrowser: c, swipeLeft: function () {
            ...
            if (!("ontouchstart" in window) || !a.options.disablehovereventontouch)
                b(".html5gallery-box-" + this.id, this.$gallery).mousemove(function () {
                    ...
                    if (a.options.titleoverlay && a.options.titleautohide && (!a.options.hidetitlewhenvideoisplaying || !a.isVideoPlaying))
                        b(".html5gallery-title-" + a.id, a.$gallery).show(), clearTimeout(a.hideTitleTimeout), a.hideTitleTimeout = setTimeout(function () {
                    ...
                    if (a.options.titleoverlay && a.options.titleautohide && (!a.options.hidetitlewhenvideoisplaying || !a.isVideoPlaying))
                        b(".html5gallery-title-" + a.id, a.$gallery).fadeIn(), clearTimeout(a.hideTitleTimeout), a.hideTitleTimeout = setTimeout(function () {
                            b(".html5gallery-title-" + a.id, a.$gallery).fadeOut();
                        }, 3E3);
                }, function () {
            ...
            b(".html5gallery-car-left-" + this.id, this.$gallery).css({ "background-position": "-" + String(2 * this.options.carouselarrowwidth) + "px 0px", cursor: "" });
            ...
            if ("vertical" == this.options.skin || "verticallight" == this.options.skin || "showcase" == this.options.skin)
                b(".html5gallery-car-list-" + this.id, this.$gallery).on("DOMMouseScroll mousewheel wheel", function (c) {
                    ...
                    if (!(e < a.options.thumbMaskHeight)) {
                        var e = -1 * (e - a.options.thumbMaskHeight), f = 0;
                        ...
                        b(".html5gallery-car-slider-" + a.id, a.$gallery).css({ top: e });
                        b(".html5gallery-thumbs-" + a.id, a.$gallery).css({ marginTop: c });
                    }
                });
            ...
            "ontouchstart" in window && ("vertical" == this.options.skin || "verticallight" == this.options.skin || "showcase" == this.options.skin ? b(".html5gallery-car-" + this.id, this.$gallery).touchSwipe({ preventWebBrowser: !0, swipeTop: function () {
                b(".html5gallery-car-right-" + a.id, a.$gallery).click();
            }, swipeBottom: function () {
                b(".html5gallery-car-left-" + a.id, a.$gallery).click();
            }, instance: a, preventWebBrowserCallback: "verticalPreventWebBrowserCallback" }) : b(".html5gallery-car-" + this.id, this.$gallery).touchSwipe({ preventWebBrowser: !1, swipeLeft: function () {
                b(".html5gallery-car-right-" + a.id, a.$gallery).click();
            }, swipeRight: function () {
                b(".html5gallery-car-left-" + a.id, a.$gallery).click();
            } }));
            ...
            switch (this.options.skin) {
                ...
                case "showcase":
                    ...
                    break;
                default: this.createStyleDefault();
            }
            ...
            if (this.container.parent() && this.container.parent().width()) {
                ...
                this.options.showcarousel && ("bottom" == this.options.carouselposition ? (this.options.carouselWidth = this.options.width, this.options.carouselHeight = this.options.carouselheight, this.options.carouselLeft = this.options.padding, this.options.carouselTop = this.options.height + this.options.headerHeight + 2 * this.options.padding, this.options.carAreaLength = this.options.carouselHeight, this.options.carouselSlider = Math.floor(this.options.carAreaLength / (this.options.thumbheight + this.options.thumbgap)) < this.elemArray.length, this.options.thumbwidth = this.options.width, this.options.carouselSlider && (this.options.thumbwidth -= 0)) : (this.options.carouselWidth = this.options.thumbwidth, this.options.carouselHeight = this.options.height + this.options.headerHeight, this.options.carTop = 0, this.options.carBottom = 0, this.options.carAreaLength = this.options.carouselHeight - this.options.carTop - this.options.carBottom, this.options.carouselSlider = Math.floor(this.options.carAreaLength / (this.options.thumbheight + this.options.thumbgap)) < this.elemArray.length, this.options.carouselSlider && (this.options.carouselWidth += 0, this.options.width -= 0, this.options.height = Math.round(this.options.width * this.options.originalHeight / this.options.originalWidth), this.options.boxWidth = this.options.width, this.options.slideshadow && (this.options.boxWidth += 8)), "left" == this.options.carouselposition ? (this.options.boxLeft = this.options.padding + this.options.carouselWidth + this.options.carouselmargin, this.options.carouselLeft = this.options.padding) : this.options.carouselLeft = this.options.padding + this.options.width + this.options.carouselmargin, this.options.carouselTop = this.options.padding), b(".html5gallery-car-mask-" + this.id).css({ width: this.options.thumbwidth + "px" }), b(".html5gallery-tn-" + this.id).css({ width: this.options.thumbwidth + "px" }), b(".html5gallery-tn-selected-" + this.id).css({ width: this.options.thumbwidth + "px" }), b(".html5gallery-car-slider-bar-" + this.id).css({ left: String(this.options.thumbwidth + 6) + "px" }), this.options.isMobile || this.isTouch && this.options.splitvsliderontouch ? (b(".html5gallery-car-left-" + this.id).css({ left: String(this.options.thumbwidth + 5) + "px" }), b(".html5gallery-car-right-" + this.id).css({ left: String(this.options.thumbwidth + 5) + "px" })) : b(".html5gallery-car-slider-" + this.id).css({ left: String(this.options.thumbwidth + 5) + "px" }), a = this.options.thumbwidth - 3 * this.options.thumbmargin, this.options.thumbshowimage && (a -= this.options.thumbimagewidth + 2 * this.options.thumbimageborder), this.options.thumbshowtitle && b("head").append("<style type='text/css' data-creator='html5gallery'>.html5gallery-tn-title-" + this.id + " {width: " + a + "px;}</style>"));
                ...
                b(".html5gallery-title-" + this.id).css({ width: a + "px" });
                this.options.titleoverlay||b(".html5gallery-title-"+this.id).css({top:91+"%"});
                b(".html5gallery-viral-" + this.id).css({ top: e + "px" });
            ...
            this.options.slideshadow && (this.options.boxWidth += 8);
            this.options.showcarousel ? "bottom" == this.options.carouselposition ? (this.options.carouselWidth = this.options.width, this.options.carouselHeight = this.options.carouselheight, this.options.carouselLeft = this.options.padding, this.options.carouselTop = this.options.height + this.options.headerHeight + 2 * this.options.padding, this.options.carAreaLength = this.options.carouselHeight, this.options.carouselSlider = Math.floor(this.options.carAreaLength / (this.options.thumbheight + this.options.thumbgap)) < this.elemArray.length, this.options.thumbwidth = this.options.width, this.options.carouselSlider && (this.options.thumbwidth -= 0)) : (this.options.carouselWidth = this.options.thumbwidth, this.options.carouselHeight = this.options.height + this.options.headerHeight, this.options.carTop = 0, this.options.carBottom = 0, this.options.carAreaLength = this.options.carouselHeight - this.options.carTop - this.options.carBottom, this.options.carouselSlider = Math.floor(this.options.carAreaLength / (this.options.thumbheight + this.options.thumbgap)) < this.elemArray.length, this.options.carouselSlider && (this.options.carouselWidth += 0), "left" == this.options.carouselposition ? (this.options.boxLeft = this.options.padding + this.options.carouselWidth + this.options.carouselmargin, this.options.carouselLeft = this.options.padding) : this.options.carouselLeft = this.options.padding + this.options.width + this.options.carouselmargin, this.options.carouselTop = this.options.padding) : (this.options.carouselWidth = 0, this.options.carouselHeight = 0, this.options.carouselLeft = 0, this.options.carouselTop = 0, this.options.carouselmargin = 0);
            ...
            var d = d + (" .html5gallery-box-" + this.id + " {display:block; position:absolute; text-align:center; left:" + this.options.boxLeft + "px; top:" + this.options.boxTop + "px; width:" + this.options.boxWidth + "px; height:" + this.options.boxHeight + "px; }"), e = Math.round(this.options.socialheight / 2 - 12),
            
            d=d+(".html5gallery-title-text-"+this.id+""+this.options.titlecss+".html5gallery-title-text-"+this.id+""+this.options.titlecsslink+".html5gallery-error-" + this.id + " " + this.options.errorcss), d = d + (" .html5gallery-description-text-" + this.id + " " + this.options.descriptioncss + " .html5gallery-description-text-" + this.id + " " + this.options.descriptioncsslink), d = d + (" .html5gallery-fullscreen-title-" + this.id + "" + this.options.lightboxtitlecss + " .html5gallery-fullscreen-title-" + this.id + "" + this.options.lightboxtitlelinkcss), d = d + (" .html5gallery-fullscreen-description-" + this.id + "" + this.options.lightboxdescriptioncss + " .html5gallery-fullscreen-description-" + this.id + "" + this.options.lightboxdescriptionlinkcss), d = d + (" .html5gallery-viral-" + this.id + " {display:block; overflow:hidden; position:absolute; text-align:left; top:" + c + "px; left:0px; width:" + this.options.boxWidth + "px; height:" + this.options.socialheight + "px; padding-top:" + e + "px;}"), c = this.options.slideshadow ? this.options.boxWidth - 8 : this.options.boxWidth, d = d + (" .html5gallery-title-" + this.id + " {display:" + (this.options.titleoverlay && this.options.titleautohide ? "none" : "block") + "; overflow:hidden; position:sticky; left:0px; width:" + c + "px; "),d=this.options.titleoverlay?"top"==this.options.headerpos?d+"top:88%;height:auto;}":d+"bottom:8%; height:auto;}" : d + ("top:" + a + "px; height:" + this.options.titleheight + "px; }"), d = d + (" .html5gallery-timer-" + this.id + " {display:block; position:absolute; top:" + String(this.options.elemTop + this.options.height - 2) + "px; left:0px; width:0px; height:2px; background-color:#cddc39; filter:alpha(opacity=60); opacity:0.6; }"), d = d + (" .html5gallery-elem-" + this.id + " {display:block; overflow:hidden; position:absolute; top:" + this.options.elemTop + "px; left:0px; width:" + this.options.boxWidth + "px; height:" + this.options.height + "px;}");
            ...
            this.options.showcarousel?(d+=".html5gallery-car-"+this.id +"{position:absolute;display:block;overflow:hidden;width:"+this.options.carouselWidth+"px;height:"+this.options.carouselHeight+"px;left:"+this.options.carouselLeft+"px;top:"+this.options.carouselTop+"px;}",d+=".html5gallery-car-list-" + this.id + " { position:absolute; display:block; overflow:hidden; top:" + this.options.carTop + "px; height:" + String(this.options.carAreaLength) + "px; left:0px; width:" + this.options.carouselWidth + "px; }", d += ".html5gallery-thumbs-" + this.id + " {margin-top:0px; height:" + String(this.elemArray.length * (this.options.thumbheight + this.options.thumbgap)) + "px;}", this.options.thumbShowNum = Math.floor(this.options.carAreaLength / (this.options.thumbheight + this.options.thumbgap)), 1 > this.options.thumbShowNum && (this.options.thumbShowNum=1),this.options.thumbMaskHeight=this.options.thumbShowNum*this.options.thumbheight+(this.options.thumbShowNum-1) * this.options.thumbgap, this.options.thumbTotalHeight = this.elemArray.length * this.options.thumbheight + (this.elemArray.length - 1) * this.options.thumbgap, this.options.carouselSliderMin = 0, this.options.carouselSliderMax = this.options.thumbMaskHeight-54,d+=".html5gallery-car-slider-bar-"+ this.id + " { position:absolute; display:" + (this.options.carouselSlider ? "block" : "none") + "; overflow:hidden; top:0px; height:" + this.options.thumbMaskHeight + "px; left:" + String(this.options.thumbwidth + 6) + "px; width:14px;}", d += " .html5gallery-car-slider-bar-top-" + this.id + " { position:absolute; display:block; top:0px; left:0px; width:14px; height:16px; background:url('" + this.options.skinfolder + "bartop.png')}", d += " .html5gallery-car-slider-bar-middle-" + this.id + " { position:absolute; display:block; top:16px; left:0px; width:14px; height:" + String(this.options.thumbMaskHeight-32)+"px; background:url('" + this.options.skinfolder + "bar.png')}", d += " .html5gallery-car-slider-bar-bottom-" + this.id + " { position:absolute; display:block; bottom:0px; left:0px; width:14px; height:16px; background:url('" + this.options.skinfolder + "barbottom.png')}", d = this.options.isMobile || this.isTouch && this.options.splitvsliderontouch ? d + (" .html5gallery-car-left-" + this.id + " { position:absolute; display:" + (this.options.carouselSlider ? "block" : "none") + "; cursor:pointer; overflow:hidden; width:16px; height:35px; left:" + String(this.options.thumbwidth + 5) + "px; top:0px; background:url('" + this.options.skinfolder + "slidertop.png')}  .html5gallery-car-right-" + this.id + " { position:absolute; display:" + (this.options.carouselSlider ? "block" : "none") + "; cursor:pointer; overflow:hidden; width:16px; height:35px; left:" + String(this.options.thumbwidth + 5) + "px; top:" + String(this.options.thumbMaskHeight-35)+"px; background:url('"+this.options.skinfolder+"sliderbottom.png')} ") : d + (" .html5gallery-car-slider-" + this.id + " { position:absolute; display:" + (this.options.carouselSlider ? "block" : "none") + "; overflow:hidden; cursor:pointer; top:0px; height:54px; left:" + String(this.options.thumbwidth + 5) + "px; width:16px; background:url('" + this.options.skinfolder + "slider.png');}"), a = 0, this.options.carouselNavButton && (a = Math.round(this.options.carAreaLength / 2 - this.options.thumbMaskHeight / 2)), d += " .html5gallery-car-mask-"+this.id+"{position:absolute;display:block;overflow:hidden;top:"+a+"px; height:"+this.options.thumbMaskHeight + "px; left:0px; width:" + this.options.thumbwidth + "px;} ", a = this.options.thumbheight, this.options.isIE || (a = this.options.thumbheight - 2), d += " .html5gallery-tn-" + this.id + " { display:block; margin-bottom:" + this.options.thumbgap + "px; text-align:center; cursor:pointer; width:" + this.options.thumbwidth + "px;height:" + a + "px;overflow:hidden;", this.options.carouselbgtransparent ? d += "background-color:transparent;":(this.options.isIE||(d+=""+this.options.carouseltopborder+";"+this.options.carouselbottomborder+";"),d +="background-color: " + this.options.carouselbgcolorend + "; background: " + this.options.carouselbgcolorend + " -webkit-gradient(linear, left top, left bottom, from(" + this.options.carouselbgcolorstart + "), to(" + this.options.carouselbgcolorend + ")) no-repeat; background: " + this.options.carouselbgcolorend + " -moz-linear-gradient(top, " + this.options.carouselbgcolorstart + ", " + this.options.carouselbgcolorend + ") no-repeat; filter: progid:DXImageTransform.Microsoft.gradient(startColorstr=" + this.options.carouselbgcolorstart + ", endColorstr=" + this.options.carouselbgcolorend + ") no-repeat; -ms-filter: 'progid:DXImageTransform.Microsoft.gradient(startColorstr=" + this.options.carouselbgcolorstart + ", endColorstr=" + this.options.carouselbgcolorend + ")' no-repeat;"), this.options.carouselbgimage && (d += "background:url('" + this.options.skinfolder + this.options.carouselbgimage + "') center top;"), d = d + "}" + (" .html5gallery-tn-selected-" + this.id + " { display:block; margin-bottom:" + this.options.thumbgap + "px;text-align:center; cursor:pointer; width:" + this.options.thumbwidth + "px;height:" + a + "px;overflow:hidden;"), this.options.carouselbgtransparent ? d += "background-color:transparent;" : (this.options.isIE || (d += "" + this.options.carouselhighlighttopborder + "" + this.options.carouselhighlightbottomborder + ";"), d += "background-color: " + this.options.carouselhighlightbgcolorend + "; background: " + this.options.carouselhighlightbgcolorend + " -webkit-gradient(linear, left top, left bottom, from(" + this.options.carouselhighlightbgcolorstart + "), to(" + this.options.carouselhighlightbgcolorend + ")) no-repeat; background: " + this.options.carouselhighlightbgcolorend + " -moz-linear-gradient(top, " + this.options.carouselhighlightbgcolorstart + ", " + this.options.carouselhighlightbgcolorend + ") no-repeat; filter: progid:DXImageTransform.Microsoft.gradient(startColorstr=" + this.options.carouselhighlightbgcolorstart + ", endColorstr=" + this.options.carouselhighlightbgcolorend + ") no-repeat; -ms-filter: 'progid:DXImageTransform.Microsoft.gradient(startColorstr=" + this.options.carouselhighlightbgcolorstart + ", endColorstr=" + this.options.carouselhighlightbgcolorend + ")' no-repeat;"), this.options.carouselbgimage && (d += "background:url('" + this.options.skinfolder + this.options.carouselbgimage + "') center top;"), d += "}", d += " .html5gallery-tn-selected-" + this.id + " .html5gallery-tn-img-" + this.id + " {background-color:" + this.options.thumbimagebordercolor + ";} .html5gallery-tn-" + this.id + " { filter:alpha(opacity=" + Math.round(100 * this.options.thumbopacity) + "); opacity:" + this.options.thumbopacity + "; }  .html5gallery-tn-selected-" + this.id + " { filter:alpha(opacity=100); opacity:1; } ", c = this.options.thumbwidth - 3 * this.options.thumbmargin, this.options.thumbshowimage ? (c -= this.options.thumbimagewidth + 2 * this.options.thumbimageborder, a = this.options.thumbshowtitle ? this.options.thumbmargin : this.options.thumbwidth / 2 - (this.options.thumbimagewidth + 2 * this.options.thumbimageborder) / 2, e = Math.round((this.options.thumbheight - 2) / 2 - (this.options.thumbimageheight + 2 * this.options.thumbimageborder) / 2), d += " .html5gallery-tn-img-" + this.id + " {display:block; overflow:hidden; float:left; margin-top:" + e + "px; margin-left:" + a + "px; width:" + String(this.options.thumbimagewidth + 2 * this.options.thumbimageborder) + "px;height:" + String(this.options.thumbimageheight + 2 * this.options.thumbimageborder) + "px;}") : d += " .html5gallery-tn-img-" + this.id + " {display:none;}", this.options.thumbshowtitle ? (d += " .html5gallery-tn-title-" + this.id + " {display:block; overflow:hidden; float:left; margin-top:0px; margin-left:" + this.options.thumbmargin + "px; width:" + c + "px;height:" + String(this.options.thumbheight - 2) + "px;" + (this.options.thumbshowdescription ? "" : "line-height:" + String(this.options.thumbheight - 2) + "px;") + "}", d += " .html5gallery-tn-title-" + this.id + this.options.thumbtitlecss, d += " .html5gallery-tn-description-" + this.id + this.options.thumbdescriptioncss) : (d += " .html5gallery-tn-title-" + this.id + " {display:none;}", d += " .html5gallery-tn-description-" + this.id + " {display:none;}"), this.carouselHighlight = function (a) {
                ...
                0 == a ? (c.css({ "background-position": "-" + String(2 * this.options.carouselarrowwidth) + "px 0px", cursor: "" }), c.data("disabled", !0)) : c.data("disabled") && (c.css({ "background-position": "0px 0px", cursor: "pointer" }), c.data("disabled", !1));
            ...
            if ("center" != this.options.imagetoolboxstyle) {
                var a = Math.round(("bottom" == this.options.headerpos || "bottomoutside" == this.options.headerpos ? 0 : this.options.headerHeight) + this.options.height / 2 - 24), c = a + Math.round(this.options.height / 2) - 32, d = this.options.boxWidth - 48, e = this.options.showfullscreenbutton ? d - 48 : d;
            ...
            if ("never" != this.options.showimagetoolbox) {
                ...
                if ("center" == this.options.imagetoolboxstyle)
                    ...
                    a += " .html5gallery-play-" + this.id + " { position:absolute; display:" + ("show" == this.options.imagetoolboxmode ? "block" : "none") + "; cursor:pointer; top:" + d + "px; left:" + f + "px; width:48px; height:48px; background:url('" + this.options.skinfolder + "side_play.svg') no-repeat top left;} ";
                    a += " .html5gallery-pause-" + this.id + " { position:absolute; display:" + ("show" == this.options.imagetoolboxmode ? "block" : "none") + "; cursor:pointer; top:" + d + "px; left:" + f + "px; width:48px; height:48px; background:url('" + this.options.skinfolder + "side_pause.svg') no-repeat top left;} ";
                    a += " .html5gallery-left-" + this.id + " { position:absolute; display:" + ("show" == this.options.imagetoolboxmode ? "block" : "none") + "; cursor:pointer; top:" + c + "px;left:0px;width:53px;height:53px;background:url('" + this.options.skinfolder + "side_prev.svg') no-repeat center center;} ";
                    a += " .html5gallery-right-" + this.id + " { position:absolute; display:" + ("show" == this.options.imagetoolboxmode ? "block" : "none") + "; cursor:pointer; top:" + c + "px;left:"+ e + "px; width:53px;height:53px;background:url('" + this.options.skinfolder + "side_next.svg')  no-repeat center center;} ";
            ...
            if (this.container.parent() && this.container.parent().width()) {
                ...
                a = this.elemArray[this.curElem][9];
                if (1 == a || this.showingPoster) {
                    var c = this.showingPoster ? this.elemArray[this.curElem][23] : this.elemArray[this.curElem][10], d = this.showingPoster ? this.elemArray[this.curElem][24] : this.elemArray[this.curElem][11];
                    if (this.isFullscreen)
                        var a = this.elemArray[this.curElem][17] ? Math.min(this.elemArray[this.curElem][17], this.fullscreenWidth) : this.fullscreenWidth, e = this.elemArray[this.curElem][18] ? Math.min(this.elemArray[this.curElem][18], this.fullscreenHeight) : this.fullscreenHeight, a = Math.min(a / c, e / d), a = 1 < a ? 1 : a;
                    else
                ...
                b(".html5gallery-title-" + this.id).css({ width: c + "px" });
                this.options.titleoverlay || b(".html5gallery-title-" + this.id).css({ top: a + "px" });
                b(".html5gallery-viral-" + this.id).css({ top: e + "px" });
                b(".html5gallery-timer-" + this.id).css({ top: String(this.options.elemTop + this.options.height - 2) + "px" });
                if (this.options.showcarousel) {
                    b(".html5gallery-car-" + this.id).css({ width: this.options.width + "px", top: this.options.carouselTop + "px" });
                    b(".html5gallery-car-list-" + this.id).css({ width: String(this.options.width - 4 - 4) + "px" });
                    ...
                    b(".html5gallery-car-left-" + this.id).css({ display: this.options.carouselNavButton ? "block" : "none" });
                    b(".html5gallery-car-right-" + this.id).css({ display: this.options.carouselNavButton ? "block" : "none" });
            ...
            for (var d = 0; d < this.elemArray.length; d++) {
                ...
                b(e).on("load", function () {
                    ...
                    var d = Math.max(a.options.thumbimagewidth / this.width, a.options.thumbimageheight / this.height), e = Math.round(d * this.width), d = Math.round(d * this.height), h = a.options.thumbshowplayonvideo && 1 != a.elemArray[this.data][9] ? "<div class='html5gallery-tn-img-play-" + a.id + "' style='display:block; overflow:hidden; position:absolute; width:100%;height:100%; top:" + a.options.thumbimageborder + "px; left:" + a.options.thumbimageborder + 'px;background:url("' + a.options.playvideothumbimage + "\") no-repeat center center;'></div>" : "", g = a.options.addthumbnailtitle && a.elemArray[this.data][7] ? ' title="' + a.elemArray[this.data][7] + '"' : "";
            ...
            var f = Math.max(e, b(document).height()), j = this.elemArray[this.curElem][17] ? Math.min(this.elemArray[this.curElem][17], this.fullscreenWidth) : this.fullscreenWidth, l = this.elemArray[this.curElem][18] ? Math.min(this.elemArray[this.curElem][18], this.fullscreenHeight) : this.fullscreenHeight, j = Math.min(j / c, l / d);
            1 > j && (c *= j, d *= j);
            ...
            b(window).scroll(function () {
                if (!g.options.isMobile || g.options.mobileresizeevent) {
                    var a = b(".html5gallery-fullscreen-box-" + g.id, g.$fullscreen), c = b(window).height(), c = b(window).scrollTop() + Math.round((c - a.height()) / 2);
                    a.css({ top: c });
                }
            });
            this.createSocial(!0);
            b(".html5gallery-fullscreen-box-" + this.id, this.$fullscreen).animate({ height: d + 2 * this.fullscreenMargin }, "slow", function () {
                b(this).animate({ width: c + 2 * g.fullscreenMargin }, "slow", function () {
                    b(this).animate({ height: "+=" + g.fullscreenBarH }, "slow", function () {
                        if (g.isFullscreen) {
                            var a = b(".html5gallery-elem-" + g.id, g.$gallery).empty().css({ top: 0, position: "relative" });
            ...
            g.options.enabletouchswipe && (a = g.options.isAndroid && g.options.enabletouchswipeonandroid ? !0 : !1, b(".html5gallery-fullscreen-box-" + this.id, this.$fullscreen).touchSwipe({ preventWebBrowser: a, swipeLeft: function () {
            ...
            this.options.arrowloop || (this.isFullscreen ? (b(".html5gallery-fullscreen-prev-" + this.id, this.$fullscreen).css({ visibility: 0 == this.curElem ? "hidden" : "visible" }), b(".html5gallery-fullscreen-next-" + this.id, this.$fullscreen).css({ visibility: this.curElem == this.elemArray.length - 1 ? "hidden" : "visible" })) : (b(".html5gallery-left-" + this.id, this.$gallery).css({ visibility: 0 == this.curElem ? "hidden" : "visible" }), b(".html5gallery-right-" + this.id, this.$gallery).css({ visibility: this.curElem == this.elemArray.length - 1 ? "hidden" : "visible" })));
            this.options.socialurlforeach && this.createSocialMedia();
            ...
            if (this.options.showtitle || this.options.lightboxshowtitle || this.options.lightboxshowdescription) {
                ...
                if (this.isFullscreen) {
                    ...
                    this.options.showtitle && (j = "", a && (j += "<div class='html5gallery-title-text-" + this.id + "'>" + a + "</div>"), this.options.showdescription && f && (j += "<div class='html5gallery-description-text-" + this.id + "'>" + f + "</div>"), b(".html5gallery-title-" + this.id, this.$gallery).html(j));
            ...
            if (!(0 > a)) {
                ...
                a = this.elemArray[this.curElem][9];
                (this.elemArray[this.curElem][5] || (this.options.lightbox || this.elemArray[this.curElem][22]) && !this.isFullscreen) && (!this.options.linkonlyonvideo || !(5 == a || 6 == a || 7 == a || 8 == a)) ? (c.css({ cursor: "pointer" }), c.off("click").on("click", function () {
            ...
            b(d).on("load", function () {
                ...
                var j = c.isFullscreen ? e : c.options.width, l = c.isFullscreen ? d : c.options.height, g = Math.round(j / 2 - e / 2), k = Math.round(l / 2 - d / 2);
                c.isFullscreen && c.adjustFullscreen(j, l);
                a.css({ width: j, height: l });
                ...
                d.length ? (a.prepend(e), a.html5boxTransition(c.id, d, e, { effect: c.options.effect, easing: c.options.easing, duration: c.options.duration, direction: c.curElem >= c.savedElem, slide: c.options.slide }, function () {
                })) : a.html(e);
            ...
            var j = Math.max(f, b(document).height()), l = this.elemArray[this.curElem][17] ? Math.min(this.elemArray[this.curElem][17], this.fullscreenWidth) : this.fullscreenWidth, g = this.elemArray[this.curElem][18] ? Math.min(this.elemArray[this.curElem][18], this.fullscreenHeight) : this.fullscreenHeight, l = Math.min(l / a, g / c);
            1 > l && (a *= l, c *= l);
            ...
            b(".html5gallery-fullscreen-timer-" + this.id, this.$fullscreen).css({ top: String(c - 4) + "px" });
            b(".html5gallery-elem-video-" + this.id, this.$fullscreen).css({ width: a + "px", height: c + "px" });
            b(".html5gallery-elem-video-container-" + this.id, this.$fullscreen).css({ width: "100%", height: "100%" });
            b(".html5gallery-elem-video-container-" + this.id, this.$fullscreen).find("video").css({ width: "100%", height: "100%" });
            b("#html5gallery-elem-video-" + this.id, this.$fullscreen).css({ width: a + "px", height: c + "px" });
            ...
            b("#html5gallery-elem-video-" + this.id, this.$fullscreen).find("iframe").attr("width", a);
            b("#html5gallery-elem-video-" + this.id, this.$fullscreen).find("iframe").attr("height", c);
            b(".html5gallery-elem-iframe-" + this.id, this.$fullscreen).css({ width: a + "px", height: c + "px" });
            ...
            var a = this.isFullscreen ? this.$fullscreen : this.$gallery, c = b(".html5gallery-elem-" + this.id, a);
            ...
            var d = this, e = this.elemArray[this.curElem][10], f = this.elemArray[this.curElem][11], j = new Image;
            b(j).on("load", function () {
                ...
                var n = Math.round(g / 2 - m / 2), s = Math.round(k / 2 - j / 2);
                d.isFullscreen && d.adjustFullscreen(g, k);
                c.css({ width: g, height: k });
                ...
                k.length ? (c.prepend(g), c.html5boxTransition(d.id, k, g, { effect: d.options.effect, easing: d.options.easing, duration: d.options.duration, direction: d.curElem >= d.savedElem, slide: d.options.slide }, function () {
                })) : c.html(g);
            ...
            if (this.isFullscreen) {
                var e = this.elemArray[this.curElem][17] ? Math.min(this.elemArray[this.curElem][17], this.fullscreenWidth) : Math.min(e, this.fullscreenWidth), j = this.elemArray[this.curElem][18] ? Math.min(this.elemArray[this.curElem][18], this.fullscreenHeight) : Math.min(f, this.fullscreenHeight);
                this.adjustFullscreen(e, j);
                f = e;
                e = j;
            }
            else
                b(".html5gallery-elem-" + this.id, this.$gallery).css({ width: this.options.width, height: this.options.height }), f = this.options.width, e = this.options.height;
            j = -1;
            ...
            if (this.options.isIE678 || this.options.isIE9 && this.options.useflashonie9 || this.options.isIE10 && this.options.useflashonie10 || this.options.isIE11 && this.options.useflashonie11)
                ...
                if (this.isHTML5 = !0, this.options.isFirefox || this.options.isOpera)
                    if (!this.elemArray[this.curElem][4] && !this.elemArray[this.curElem][3] && (!this.options.canplaymp4 || this.options.useflashformp4onfirefox))
                        this.isHTML5 = !1;
            if (this.isHTML5) {
                var l = this.elemArray[this.curElem][2], g = this.elemArray[this.curElem][13];
                if (this.options.isFirefox || this.options.isOpera)
                    this.elemArray[this.curElem][4] ? l = this.elemArray[this.curElem][4] : this.elemArray[this.curElem][3] && (l = this.elemArray[this.curElem][3]), this.elemArray[this.curElem][15] ? g = this.elemArray[this.curElem][15] : this.elemArray[this.curElem][14] && (g = this.elemArray[this.curElem][14]);
            ...
            this.isFullscreen ? this.adjustFullscreen(c, d) : b(".html5gallery-elem-" + this.id, this.$gallery).css({ width: this.options.width, height: this.options.height });
            ...
            var b = a.match(/(\?v=|\/\d\/|\/embed\/|\/v\/|\.be\/)([a-zA-Z0-9\-\_]+)/)[2], b = "https://www." + (-1 !== a.indexOf("youtube-nocookie.com") ? "youtube-nocookie.com" : "youtube.com") + "/embed/" + b;
            ...
            if (this.isFullscreen) {
                ...
                b(".html5gallery-elem-" + this.id, this.$gallery).css({ width: this.options.width, height: this.options.height }), e = this.options.width, d = this.options.height;
            ...
            f = this.elemArray[this.curElem][2];
            b(".html5gallery-elem-" + this.id, c).html("<div class='html5gallery-loading-center-" + this.id + "'></div><div id='html5gallery-elem-video-" + this.id + "' style='display:block;position:absolute;overflow:hidden;top:" + (this.options.slideshadow && !this.isFullscreen ? 4 : 0) + "px;left:" + (this.options.slideshadow && !this.isFullscreen ? 4 : 0) + "px;width:" + e + "px;height:" + d + "px;'></div>" + this.options.watermarkcode);
            var j = -1 !== f.indexOf("youtube-nocookie.com"), l = this;
            ...
            ASYouTubeIframeAPIReady && !this.options.isMobile && !this.options.isIE6 && !this.options.isIE7 && !j ? (c = this.elemArray[this.curElem][2].match(/(\?v=|\/\d\/|\/embed\/|\/v\/|\.be\/)([a-zA-Z0-9\-\_]+)/)[2], f = function () {
            }, a && (f = function (a) {
                a.target.playVideo();
            }), j = this.getYoutubeParams(this.elemArray[this.curElem][2]), j = b.extend({ html5: 1, controls: l.options.videohidecontrols ? "0" : "1", showinfo: l.options.videohidecontrols ? "0" : "1", autoplay: a ? 1 : 0, rel: 0, wmode: "transparent" }, j), this.ytPlayer = new YT.Player("html5gallery-elem-video-" + this.id, { width: e, height: d, videoId: c, playerVars: j, events: { onReady: f, onStateChange: function (a) {
            ...
            var a = this.isFullscreen ? this.$fullscreen : this.$gallery, c = this.elemArray[this.curElem][10], d = this.elemArray[this.curElem][11];
            if (this.isFullscreen) {
                var c = this.elemArray[this.curElem][17] ? Math.min(this.elemArray[this.curElem][17], this.fullscreenWidth) : Math.min(c, this.fullscreenWidth), e = this.elemArray[this.curElem][18] ? Math.min(this.elemArray[this.curElem][18], this.fullscreenHeight) : Math.min(d, this.fullscreenHeight);
                this.adjustFullscreen(c, e);
                d = c;
                c = e;
            }
            else
                b(".html5gallery-elem-" + this.id, this.$gallery).css({ width: this.options.width, height: this.options.height }), d = this.options.width, c = this.options.height;
            ...
            a.html("<div class='html5gallery-elem-video-container-" + this.id + "' style='position:relative;display:block;background-color:;width:100%;height:100%;'><video id='html5gallery-elem-html5-video-" + this.id + "' width='100%' height='100%'" + (this.options.nativehtml5controls && !this.options.videohidecontrols ? " controls" : "") + (this.options.html5videonodownload ? ' controlsList="nodownload"' : "") + (this.options.mutevideo ? " muted" : "") + (this.options.playsinline ? " playsinline" : "") + (this.options.loopvideo ? " loop" : "") + (this.options.donotuseposter && this.options.showhtml5videoposter && this.elemArray[this.curElem][0] ? ' poster="' + this.elemArray[this.curElem][0] + '"' : "") + "></div>");
            ...
            this.elemArray[this.curElem][5] && (b("video", a).css({ cursor: "pointer" }), b("video", a).off("click").on("click", function () {
        ...
        this.each(function () {
            ...
            if ((!b(this).data("donotinit") || k && k.forceinit) && !b(this).data("inited")) {
                ...
                c = { skinfolder: "skins/horizontal/", padding: 6, bgcolor: "#ffffff", bgimage: "", galleryshadow: !0, slideshadow: !1, showsocialmedia: !1, headerpos: "top", showdescription: !0, titleoverlay: !0, titleautohide: !0, titlecss: " {color:#ffffff; font-size:13px; font-family:Arial,Helvetica,sans-serif; overflow:hidden; text-align:center; padding:2px 0px 2px 2px; background:rgb(102, 102, 102) transparent; background: rgba(102, 102, 102, 0.6); filter:'progid:DXImageTransform.Microsoft.gradient(startColorstr=#99666666, endColorstr=#99666666)'; -ms-filter:'progid:DXImageTransform.Microsoft.gradient(startColorstr=#99666666, endColorstr=#99666666)'; }", titlecsslink: " a {color:#ffffff;}", descriptioncss: "{color:#ffffff; font-size:13px; font-family:Arial,Helvetica,sans-serif; overflow:hidden;text-align:left;padding:0px 0px 10px 10px;background:rgb(102, 102, 102)transparent;background:rgba(102, 102, 102, 0.6);filter:'progid:DXImageTransform.Microsoft.gradient(startColorstr=#99666666,endColorstr=#99666666)';-ms-filter:'progid:DXImageTransform.Microsoft.gradient(startColorstr=#99666666,endColorstr=#99666666)';}",descriptioncsslink:"a{color:#ffffff;}",showcarousel: !0, carouselmargin: 0, carouselbgtransparent: !1, carouselbgcolorstart: "", carouselbgcolorend: "", carouseltopborder: "", carouselbottomborder: "", thumbwidth: 64, thumbheight: 48, thumbgap: 4, thumbmargin: 6, thumbunselectedimagebordercolor:"#ffffff",thumbimageborder:1,thumbimagebordercolor:"",thumbshowplayonvideo:!0,thumbshadow: !1, thumbopacity: 0.8 };
                var h = { padding:0, skinfolder: "skins/light/", bgcolor: "", bgimage: "", galleryshadow: !1, slideshadow: !0, showsocialmedia: !1, headerpos: "top", showdescription: !0, titleoverlay: !0, titleautohide: !0, titlecss: " {color:#ffffff; font-size:13px; font-family:Arial,Helvetica,sans-serif; overflow:hidden;white-space:normal;text-align:center;padding:2px 0px 2px 2px;  background:rgb(102, 102, 102) transparent; background: rgba(102, 102, 102, 0.6); filter:'progid:DXImageTransform.Microsoft.gradient(startColorstr=#99666666, endColorstr=#99666666)'; -ms-filter:'progid:DXImageTransform.Microsoft.gradient(startColorstr=#99666666, endColorstr=#99666666)'; }", titlecsslink: " a {color:#ffffff;}", descriptioncss: " {color:#ffffff; font-size:12px; font-family:Arial,Helvetica,sans-serif; overflow:hidden; white-space:normal; text-align:left;padding:0px 0px 10px 10px;background:rgb(102, 102, 102) transparent; background: rgba(102, 102, 102, 0.6); filter:'progid:DXImageTransform.Microsoft.gradient(startColorstr=#99666666, endColorstr=#99666666)'; -ms-filter:'progid:DXImageTransform.Microsoft.gradient(startColorstr=#99666666, endColorstr=#99666666)'; }", descriptioncsslink: " a {color:#ffffff;}", showcarousel: !0, carouselmargin: 10, carouselbgtransparent: !0, thumbwidth: 48, thumbheight: 48, thumbgap: 8, thumbmargin: 12, thumbunselectedimagebordercolor: "#fff", thumbimageborder: 2, thumbimagebordercolor: "#fff", thumbshowplayonvideo: !0, thumbshadow: !0, thumbopacity: 0.8 },
                ...
                j = { padding:0, skinfolder: "skins/gallery/", bgcolor: "", bgimage: "", galleryshadow: !1, slideshadow: !0, showsocialmedia: !1, headerpos: "top", showdescription: !0, titleoverlay: !0, titleautohide: !0, titlecss: " {color:#ffffff; font-size:14px; font-family:Arial,Helvetica,sans-serif; overflow:hidden; white-space:normal; text-align:left; padding:10px 0px 10px 10px;  background:rgb(102, 102, 102) transparent; background: rgba(102, 102, 102, 0.6); filter:'progid:DXImageTransform.Microsoft.gradient(startColorstr=#99666666, endColorstr=#99666666)'; -ms-filter:'progid:DXImageTransform.Microsoft.gradient(startColorstr=#99666666, endColorstr=#99666666)'; }", titlecsslink: " a {color:#ffffff;}", descriptioncss: " {color:#ffffff; font-size:12px; font-family:Arial,Helvetica,sans-serif; overflow:hidden; white-space:normal; text-align:left; padding:0px 0px 10px 10px;  background:rgb(102, 102, 102) transparent; background: rgba(102, 102, 102, 0.6); filter:'progid:DXImageTransform.Microsoft.gradient(startColorstr=#99666666, endColorstr=#99666666)'; -ms-filter:'progid:DXImageTransform.Microsoft.gradient(startColorstr=#99666666, endColorstr=#99666666)'; }", descriptioncsslink: " a {color:#ffffff;}", showcarousel: !0, carouselmargin: 10, carouselbgtransparent: !0, thumbwidth: 120, thumbheight: 60, thumbgap: 8, thumbmargin: 12, thumbunselectedimagebordercolor: "#fff", thumbimageborder: 2, thumbimagebordercolor: "#fff", thumbshowplayonvideo: !0, thumbshadow: !0, thumbopacity: 0.8, thumbshowtitle: !0, thumbtitlecss: "{text-align:center; color:#000; font-size:12px; font-family:Arial,Helvetica,sans-serif; overflow:hidden; white-space:normal;}", thumbtitleheight: 18 },
                l = { padding:0, skinfolder: "skins/gallery/", bgcolor: "", bgimage: "", galleryshadow: !1, slideshadow: !0, showsocialmedia: !1, headerpos: "bottom", showdescription: !0, titleoverlay: !1, titleheight: 72, titleautohide: !0, titlecss: "{color:#333;font-size:14px;font-family:Arial,Helvetica,sans-serif;overflow:hidden;text-align:center;padding:16px 8px 4px 8px;}", titlecsslink: "a{color:#333;}", descriptioncss: "{color:#333;font-size:12px;font-family:Arial,Helvetica,sans-serif;overflow:hidden;text-align:center;padding:4px 8px; }", descriptioncsslink: "a{color:#333;}", titlesmallscreen: !0, showcarousel: !0, carouselmargin: 10, carouselbgtransparent: !0, thumbwidth: 120, thumbheight: 60, thumbgap: 8, thumbmargin: 12, thumbunselectedimagebordercolor: "#fff", thumbimageborder: 2, thumbimagebordercolor: "#fff", thumbshowplayonvideo: !0, thumbshadow: !0, thumbopacity: 0.8, thumbshowtitle: !1, thumbtitlecss: "{text-align:center; color:#000; font-size:12px; font-family:Arial,Helvetica,sans-serif; overflow:hidden; white-space:normal;}", thumbtitleheight: 18 },
                g = { padding:0, skinfolder: "skins/gallery/", bgcolor: "", bgimage: "", galleryshadow: !1, slideshadow: !0, showsocialmedia: !1, headerpos: "bottom", showdescription: !0, titleoverlay: !1, titleheight: 72, titleautohide: !0, titlecss: "{color:#333;font-size:14px;font-family:Arial,Helvetica,sans-serif;overflow:hidden;text-align:center;padding:16px 8px 4px 8px;}", titlecsslink: "a{color:#333;}", descriptioncss: "{color:#333;font-size:12px;font-family:Arial,Helvetica,sans-serif;overflow:hidden;text-align:center;padding:4px 8px; }", descriptioncsslink: "a{color:#333;}", titlesmallscreen: !0, showcarousel: !0, carouselmargin: 10, carouselposition: "top", carouselbgtransparent: !0, thumbwidth: 120, thumbheight: 60, thumbgap: 8, thumbmargin: 12, thumbunselectedimagebordercolor: "#fff", thumbimageborder: 2, thumbimagebordercolor: "#fff", thumbshowplayonvideo: !0, thumbshadow: !0, thumbopacity: 0.8, thumbshowtitle: !0, thumbtitlecss: "{text-align:center; color:#000; font-size:12px; font-family:Arial,Helvetica,sans-serif; overflow:hidden; white-space:normal;}", thumbtitleheight: 18 },
                m = { padding:0, skinfolder: "skins/gallery/", bgcolor: "", bgimage: "", galleryshadow: !1, slideshadow: !0, showsocialmedia: !1, headerpos: "bottomoutside", showdescription: !0, titleoverlay: !1, titleheight: 72, titleautohide: !0, titlecss: "{color:#333;font-size:14px;font-family:Arial,Helvetica,sans-serif;overflow:hidden;text-align:center;padding:16px 8px 4px 8px;}", titlecsslink: "a{color:#333;}", descriptioncss: "{color:#333;font-size:12px;font-family:Arial,Helvetica,sans-serif;overflow:hidden;text-align:center;padding:4px 8px; }", descriptioncsslink: "a{color:#333;}", titlesmallscreen: !0, showcarousel: !0, carouselmargin: 10, carouselbgtransparent: !0, thumbwidth: 120, thumbheight: 60, thumbgap: 8, thumbmargin: 12, thumbunselectedimagebordercolor: "#fff", thumbimageborder: 2, thumbimagebordercolor: "#fff", thumbshowplayonvideo: !0, thumbshadow: !0, thumbopacity: 0.8, thumbshowtitle: !0, thumbtitlecss: "{text-align:center; color:#000; font-size:12px; font-family:Arial,Helvetica,sans-serif; overflow:hidden; white-space:normal;}", thumbtitleheight: 18 },
               
                n={skinfolder:"skins/darkness/",padding:0,bgcolor:"",bgimage:"",galleryshadow:!1,slideshadow:!1,headerpos:"bottom",showdescription: !1, titleoverlay: !1, titleautohide: !1, titlecss:"{color:#ffffff;font-size:13px;font-family:Arial,Helvetica,sans-serif;overflow:hidden;white-space:normal;text-align:center;padding:2px 0px;}",titlecsslink:"a{color:#ffffff;}",descriptioncss:"{color:#ffffff;font-size:12px;font-family:Arial,Helvetica,sans-serif;overflow:hidden;white-space:normal;text-align:left; padding:0px 0px 10px 0px;}", descriptioncsslink: "a {color:#ffffff;}",showcarousel:!0,carouselmargin:8,carouselbgtransparent:!1,carouselbgcolorstart:"rgba(77, 57, 0, 0.4588235294117647)",carouselbgcolorend:"#4d3900",carouseltopborder:"",carouselbottomborder:"",thumbwidth:64,thumbheight:48,thumbgap:4,thumbmargin: 6, thumbunselectedimagebordercolor:"",thumbimageborder:0, thumbimagebordercolor:"",thumbshowplayonvideo:!0,thumbshadow:!1,thumbopacity:0.8},
                s={ skinfolder: "skins/verticallight/", padding:0, bgcolor: "#fff", bgimage: "", galleryshadow: !1, slideshadow: !1, headerpos: "bottom", showdescription: !1, titleoverlay: !1, titleautohide: !1, titlecss:"{color:#333; font-size:13px;font-family:Arial,Helvetica,sans-serif;overflow:hidden;white-space:normal; text-align:center; padding:2px 0px;}", titlecsslink: " a {color:#333;}", descriptioncss: " {color:#333; font-size:12px; font-family:Arial,Helvetica,sans-serif; overflow:hidden; white-space:normal; text-align:left; padding:0px 0px 10px 0px;}", descriptioncsslink: " a {color:#333;}", showcarousel: !0, carouselmargin: 8, carouselposition: "right", carouselposresponsive: !0, carouselposresponsiveonscreenwidth: 800, carouselheight: 280, carouselbgtransparent: !1, carouselbgcolorstart:"#fff",carouselbgcolorend: "#fff", carouseltopborder:"",carouselbottomborder:"",carouselhighlightbgcolorstart:"#f0f0f0",carouselhighlightbgcolorend:"#f0f0f0",carouselhighlighttopborder:"",carouselhighlightbottomborder:"",carouselhighlightbgimage:"",thumbwidth: 148, thumbheight: 48, thumbgap: 2, thumbmargin:6,thumbunselectedimagebordercolor:"",thumbimageborder:0,thumbimagebordercolor:"#fff",thumbshowplayonvideo:!0,thumbshadow:!1, thumbopacity: 0.8,thumbshowimage:!0,thumbshowtitle:!0,thumbtitlecss:"{text-align:center; color:#333; font-size:12px; font-family:Arial,Helvetica,sans-serif; overflow:hidden; white-space:normal;}" },
                t={skinfolder:"baspa/",padding:0,bgcolor:"",bgimage:"",galleryshadow:!1,slideshadow:!1,headerpos: "bottom",showdescription:!1,titleoverlay:!1,titleautohide:!1,titlecss:"{color:#898778;font-size:10px; font-family:Arial,Helvetica,sans-serif; overflow:hidden; white-space:normal; text-align:center; padding:2px 0px;}", titlecsslink: " a {color:#ffffff;}",descriptioncss:"{color:#ffffff;font-size:12px;font-family:Arial,Helvetica,sans-serif;overflow:hidden;white-space:normal;text-align:left;padding:0px 0px 10px 0px;}",descriptioncsslink:"a{color:#ffffff;}",showcarousel:!0,carouselmargin:8,carouselposition:"right",carouselposresponsive:!0,carouselposresponsiveonscreenwidth:800,carouselheight:280,carouselbgtransparent:!1,carouselbgcolorstart:"",carouselbgcolorend:"#4d3900",carouseltopborder:"",carouselbottomborder:"",carouselhighlightbgcolorstart:"",carouselhighlightbgcolorend:"#FFEB3B",carouselhighlighttopborder:"",carouselhighlightbottomborder:"",carouselhighlightbgimage:"",thumbwidth:148,thumbheight:48,thumbgap:2,thumbmargin:6,thumbunselectedimagebordercolor:"",thumbimageborder:0,thumbimagebordercolor:"",thumbshowplayonvideo:!0,thumbshadow:!1,thumbopacity:0.8,thumbshowimage:!0,thumbshowtitle:!0,thumbtitlecss:"{text-align:center;color:#ffffff;font-size:10px; font-family:Arial,Helvetica,sans-serif;overflow:hidden; white-space:normal;}"},
                x={skinfolder:"skins/showcase/",padding:0,bgcolor:"",bgimage: "", galleryshadow: !1, slideshadow: !1, showsocialmedia: !1, headerpos: "bottom", showdescription: !1, titleoverlay: !1, titleautohide: !1, titlecss: " {color:#ffffff; font-size:16px; font-family:Arial,Helvetica,sans-serif; overflow:hidden; white-space:normal; text-align:center; padding:10px 0px;}", titlecsslink: " a {color:#ffffff;}", descriptioncss: " {color:#ffffff; font-size:10px; font-family:Arial,Helvetica,sans-serif; overflow:hidden; white-space:normal; text-align:left; padding:0px 0px 10px 0px;}", descriptioncsslink: " a {color:#ffffff;}", showcarousel: !0, carouselmargin: 8, carouselposition: "bottom", carouselheight: 280, carouselposresponsive: !1, carouselbgtransparent: !1, carouselbgcolorstart:"",carouselbgcolorend:"#4d3900",carouseltopborder:"",carouselbottomborder:"",carouselhighlightbgcolorstart:"",carouselhighlightbgcolorend:"#FFEB3B",carouselhighlighttopborder:"",carouselhighlightbottomborder:"",carouselhighlightbgimage:"",thumbwidth:148,thumbheight:60,thumbgap:2,thumbmargin:6,thumbunselectedimagebordercolor:"",thumbimageborder:0,thumbimagebordercolor:"",thumbshowplayonvideo:!0,thumbshadow:!1,thumbopacity:0.8,thumbshowimage:!0,thumbshowtitle:!0,thumbtitlecss:"{text-align:left;color:#ffffff;font-size:10px;font-family:Arial,Helvetica,sans-serif; overflow:hidden; padding: 6px 0;}", thumbshowdescription: !0, thumbdescriptioncss: "{font-size:10px;}" },
                z = { freelink: "", watermark: "", watermarklink: "", enabletabindex: !1, playvideoimage: "oinatu.svg", playvideothumbimage: "playvideo.png", loadinggif: "loading.gif", centerloadinggif: "loading_center.gif", skin: "horizontal", googlefonts: "", mobileresizeevent: !1, enabletouchswipe: !0, enabletouchswipeonandroid: !1, disablehovereventontouch: !1, responsive: !1, responsivefullscreen: !1, resizedelay: 10, screenquery: {}, firstitemid: 0, addimgtitle: !1, src: "", xml: "", xmlnocache: !0, stopallplaying: !1, lightbox: !1, autoslide: !1, slideshowinterval: 6E3, random: !1, borderradius: 0, loop: 0, pauseonmouseover: !1, arrowloop: !0, setfirstslideshowinterval: !1, firstslideshowinterval: 6E3, reverse: !1, notupdatecarousel: !1, updatecarouselinterval: 6E4, youtubeimage: "0.jpg", youtubethumb: "0.jpg", autoplayvideo: !1, html5player: !0, playvideoonclick: !0, videohidecontrols: !1, useflashformp4onfirefox: !1, reloadonvideoend: !1, loadnextonvideoend: !1, nativehtml5controls: !1, hddefault: !1,useflashonie9:!0,useflashonie10:!1,useflashonie11:!1,fullscreennativecontrols:!0,html5videonodownload:!0,usenativehtml5controlsoniphone:!0,usenativehtml5controlsonipad:!0,usenativehtml5controlsonandroid:!0,usenativehtml5controlsonie:!1,usenativehtml5controlsonfirefox:!1,defaultvideovolume:1,mutevideo: !1, playsinline: !1, loopvideo: !1, autoslideandplayafterfirstplayed: !1, lazyloadtags: "lazy-src,lazyload-src,cfsrc,src", linkonlyonvideo: !0, hidetitlewhenvideoisplaying: !1, hideplaypausefullscreenwhenvideoisplaying: !1, lightboxborder: 8, lightboxtextheight: 72, lightboxmargin: 12, lightboxbgcolor: "#fff", lightboxshowtitle: !0, lightboxtitlecss: " {color:#333333;font:bold 12px Arial,Helvetica,sans-serif; overflow:hidden; white-space:normal; line-height:18px;}", lightboxtitlelinkcss: " a {color:#333333;}", lightboxshowdescription: !0, lightboxdescriptioncss: " {color:#333333; font:normal 12px Arial,Helvetica,sans-serif; overflow:hidden; white-space:normal; line-height:14px;}", lightboxdescriptionlinkcss: " a {color:#333333;}", effect: "fade", easing: "easeOutCubic", duration: 1500, slide: { duration: 1E3, easing: "easeOutExpo" }, width: 480, height: 270, showtimer: !0, resizemode: "fit", showtitle: !0, titleheight:20, errorcss: " {text-align:center; color:#ff0000; font-size:14px; font-family:Arial, sans-serif;}", shownumbering: !1, numberingformat: "%NUM / %TOTAL", googleanalyticsaccount: "", showsocialmedia: !1, socialheight: 48, socialurlforeach: !1, showfacebooklike: !0, facebooklikeurl: "", twitterurl: "", twitterusername: "", twittervia: "html5box", showgoogleplus: !0, googleplusurl: "", initsocial: !1, showsocial: !1, socialmode: "mouseover", socialposition: "position:absolute;top:8px;right:8px;", socialpositionlightbox: "position:absolute;top:8px;right:8px;", socialdirection: "horizontal", socialbuttonsize: 32, socialbuttonfontsize: 18, socialrotateeffect: !0, showfacebook: !0, showtwitter: !0, showpinterest: !0, showlinkedin: !1, showgplus: !1, showemail: !1, showimagetoolbox: "always", imagetoolboxstyle: "side", imagetoolboxmode: "mouseover", showplaybutton: !0, showprevbutton: !0, shownextbutton: !0, showfullscreenbutton: !0, showplaypausefullscreenforall: !1, showcarouselforsingle: !1, carouselbgtransparent: !0, carouselbgcolorstart: "#ffffff", carouselbgcolorend: "#ffffff", carouseltopborder: "#ffffff", carouselbottomborder: "#ffffff", carouselbgimage: "", carouseleasing: "easeOutCirc", carouselarrowwidth: 32, carouselarrowheight: 32, thumbresponsive: "samesize", thumbcolumns: 5, thumbcolumnsresponsive: !1, thumbmediumcolumns: 3, thumbmediumsize: 800, thumbsmallcolumns: 2, thumbsmallsize: 480, thumbmediumwidth:64,thumbmediumheight:64,thumbsmallwidth:48,thumbsmallheight:48,addthumbnailtitle: !1,carouselmultirows: !1, thumbrowgap: 16, thumblinkintitle: !1, thumbjumptotop: !1, thumbjumpposition: -1, thumbjumpanchor: "", thumbshowtitle: !1, thumbtitlecss: "{text-align:center; color:#000; font-size:12px; font-family:Arial,Helvetica,sans-serif; overflow:hidden;}", thumbtitleheight: 24, thumbmediumtitleheight:48, thumbsmalltitleheight:72,youtubeapikey: "", youtubeplaylistid: "", youtubeplaylistmaxresults: "", youtubeplaylistusemaxres: !0, titlesmallscreen: !1, titlesmallscreenwidth: 640, titleheightsmallscreen: 148, donotuseposter: !1, showhtml5videoposter: !0, splitvsliderontouch: !0, forcetouch: !1, version: "3.6", frve: !0, fm: "72,84,77,76,53,32,71,97,108,108,101,114,121,32,70,114,101,101,32,86,101,114,115,105,111,110" }, 
                ...
                if (this.options.screenquery)
                    for (c in this.options.screenquery)
                        h <= this.options.screenquery[c].screenwidth && (this.options.screenquery[c].gallerywidth && (this.options.width = this.options.screenquery[c].gallerywidth), this.options.screenquery[c].galleryheight && (this.options.height = this.options.screenquery[c].galleryheight), this.options.screenquery[c].thumbwidth && (this.options.thumbwidth = this.options.screenquery[c].thumbwidth), this.options.screenquery[c].thumbheight && (this.options.thumbheight = this.options.screenquery[c].thumbheight));
...
function HTML5GalleryTimer(u, s, m) {
    ...
    this.resume = function (u) {
        if (!b || u)
            b = !1, n && A && (A = !1, x = setInterval(function () {
                k += 50;
...
function HTML5GallerySWFObjectFunc() {
    ...
    function t() {
        ...
        if (0 < b)
            for (var c = 0; c < b; c++) {
                var g = z[c].id, j = z[c].callbackFn, h = { success: !1, id: g };
                if (0 < p.pv[0]) {
                    var l = e(g);
                    if (l)
                        if (a(z[c].swfVersion) && !(p.wk && 312 > p.wk))
                            d(g, !0), j && (h.success = !0, h.ref = x(g), j(h));
                            ...
                            for (var m = {}, l = l.getElementsByTagName("param"), r = l.length, q = 0; q < r; q++)
                                "movie" != l[q].getAttribute("name").toLowerCase() && (m[l[q].getAttribute("name")] = l[q].getAttribute("value"));
                            A(h, m, g, j);
                        }
                        else
                            n(l), j && j(h);
    ...
    function F(a, b, c) {
        ...
        if (g)
            if (typeof a.id == f && (a.id = c), p.ie && p.win) {
                ...
                for (var n in a)
                    a[n] != Object.prototype[n] && ("styleclass" == n.toLowerCase() ? m.setAttribute("class", a[n]) : "classid" != n.toLowerCase() && m.setAttribute(n, a[n]));
                for (h in b)
                    b[h] != Object.prototype[h] && "movie" != h.toLowerCase() && (a = m, k = h, n = b[h], c = q.createElement("param"), c.setAttribute("name", k), c.setAttribute("value", n), a.appendChild(c));
    ...
    function c(a, b, c, d) {
        if (!p.ie || !p.mac) {
            ...
            if (e) {
                ...
                d && (J = v = null);
                if (!v || J != c)
                    d = q.createElement("style"), d.setAttribute("type", "text/css"), d.setAttribute("media", c), v = e.appendChild(d), p.ie && (p.win && typeof q.styleSheets != f && 0 < q.styleSheets.length) && (v = q.styleSheets[q.styleSheets.length - 1]), J = c;
    ...
    var f = "undefined", j = "object", l = "application/x-shockwave-flash", g = "SWFObjectExprInst", w = window, q = document, I = navigator, $ = !1, R = [function () {
        if ($) {
            var a = q.getElementsByTagName("body")[0], b = q.createElement(j);
            ...
            t();
    }], z = [], S = [], N = [], D, T, X, r, B = !1, E = !1, v, J, L = !0, p, U = typeof q.getElementById != f && typeof q.getElementsByTagName != f && typeof q.createElement != f, G = I.userAgent.toLowerCase(), C = I.platform.toLowerCase(), O = C ? /win/.test(C) : /win/.test(G), C = C ? /mac/.test(C) : /mac/.test(G), G = /webkit/.test(G) ? parseFloat(G.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, P = !+"\v1", M = [0, 0, 0], y = null;
    if (typeof I.plugins != f && typeof I.plugins["Shockwave Flash"] == j) {
        if ((y = I.plugins["Shockwave Flash"].description) && !(typeof I.mimeTypes != f && I.mimeTypes[l] && !I.mimeTypes[l].enabledPlugin))
            $ = !0, P = !1, y = y.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), M[0] = parseInt(y.replace(/^(.*)\..*$/, "$1"), 10), M[1] = parseInt(y.replace(/^.*\.(.*)\s.*$/, "$1"), 10), M[2] = /[a-zA-Z]/.test(y) ? parseInt(y.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0;
    }
    else if (typeof w.ActiveXObject != f)
        try {
            var H = new ActiveXObject("ShockwaveFlash.ShockwaveFlash");
            if (H && (y = H.GetVariable("$version")))
                P = !0, y = y.split(" ")[1].split(","), M = [parseInt(y[0], 10), parseInt(y[1], 10), parseInt(y[2], 10)];
        }
        catch (Y) {
        }
    p = { w3: U, pv: M, wk: G, ie: P, win: O, mac: C };
    ...
    return { registerObject: function (a, b, c, e) {
        ...
        p.w3 && !(p.wk && 312 > p.wk) && b && c && e && g && h ? (d(c, !1), s(function () {
            ...
            if (a(h))
                u = F(p, s, c), p.id == c && d(c, !0), t.success = !0, t.ref = u;
            else {
                if (l && k()) {
                    p.data = l;
                    A(p, s, c, r);
        ...
        p.w3 && c(a, b, d, e);
    }, addDomLoadEvent: s, addLoadEvent: m, getQueryParamValue: function (a) {
