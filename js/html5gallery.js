    ...
    b.fn.html5gallery = function (k) {
        ...
        this.each(function () {
            ...
            if ((!b(this).data("donotinit") || k && k.forceinit) && !b(this).data("inited")) {
                ...
                x={skinfolder:"skins/showcase/",padding:0,bgcolor:"",bgimage: "", galleryshadow: !1, slideshadow: !1, showsocialmedia: !1, headerpos: "bottom", showdescription: !1, titleoverlay: !1, titleautohide: !1, titlecss: " {color:#ffffff; font-size:16px; font-family:Arial,Helvetica,sans-serif; overflow:hidden; white-space:normal; text-align:center; padding:10px 0px;}", titlecsslink: " a {color:#ffffff;}", descriptioncss: " {color:#ffffff; font-size:12px; font-family:Arial,Helvetica,sans-serif; overflow:hidden; white-space:normal; text-align:left; padding:0px 0px 10px 0px;}", descriptioncsslink: " a {color:#ffffff;}", showcarousel: !0, carouselmargin: 8, carouselposition: "bottom", carouselheight: 280, carouselposresponsive: !1, carouselbgtransparent: !1, carouselbgcolorstart:"",carouselbgcolorend:"#4d3900",carouseltopborder:"",carouselbottomborder:"",carouselhighlightbgcolorstart:"",carouselhighlightbgcolorend:"#FFEB3B",carouselhighlighttopborder:"",carouselhighlightbottomborder:"",carouselhighlightbgimage:"",thumbwidth:148,thumbheight:60,thumbgap:2,thumbmargin:6,thumbunselectedimagebordercolor:"",thumbimageborder:0,thumbimagebordercolor:"",thumbshowplayonvideo:!0,thumbshadow:!1,thumbopacity:0.8,thumbshowimage:!0,thumbshowtitle:!0,thumbtitlecss:"{text-align:left; color:#ffffff; font-size:12px;font-family:Arial,Helvetica,sans-serif; overflow:hidden; padding: 6px 0;}", thumbshowdescription: !0, thumbdescriptioncss: "{font-size:10px;}" },
