...
function loadHtml5Gallery(v) {
    ...
    jQuery.extend(jQuery.easing, {
        ...
        easeInElastic: function(b, e, a, c, d) {
            ...
            h || (h = 0.3 * d);
            f < Math.abs(c) ? (f = c,
            b = h / 4) : b = h / (2 * Math.PI) * Math.asin(c / f);
    ...
    s.fn.touchSwipe = function(b) {
        ...
        return this.each(function() {
            function a(a) {
                ...
                1 <= b.targetTouches.length ? (f = b.targetTouches[0].pageX,
                j = b.targetTouches[0].pageY) : h(a)
            }
            function b(a) {
                var c = e.preventWebBrowser
                  , d = a.originalEvent;
                1 <= d.targetTouches.length ? (l = d.targetTouches[0].pageX,
                g = d.targetTouches[0].pageY,
                e.instance && e.preventWebBrowserCallback && (c = e.instance[e.preventWebBrowserCallback](g < j))) : h(a);
                c && a.preventDefault()
            }
            function d(a) {
                if (0 < l || 0 < g)
                    100 < Math.abs(l - f) && (l > f ? e.swipeRight && e.swipeRight.call() : e.swipeLeft && e.swipeLeft.call()),
                    100 < Math.abs(g - j) && (g > j ? e.swipeBottom && e.swipeBottom.call() : e.swipeTop && e.swipeTop.call());
                h(a)
            }
            function h() {
                g = l = j = f = -1
            ...
            var f = -1
              ...
              , g = -1;
            try {
                s(this).on("touchstart", a),
                s(this).on("touchmove", b),
                s(this).on("touchend", d),
                s(this).on("touchcancel", h)
            } catch (w) {}
        })
    }
    ;
      ...
      , k = x.drag = {
        ...
        add: function(b) {
            var e = q.data(this, k.datakey)
              , a = b.data || {};
            e.related += 1;
            !e.live && b.selector && (e.live = !0,
            u.add(this, "draginit." + k.livekey, k.delegate));
        ...
        teardown: function() {
            q.data(this, k.datakey).related || (q.removeData(this, k.datakey),
            u.remove(this, "mousedown", k.init),
            u.remove(this, "draginit", k.delegate),
            k.textselect(!0),
            this.detachEvent && this.detachEvent("ondragstart", k.dontstart))
        },
        init: function(b) {
            var e = b.data, a;
            if (!(0 < e.which && b.which != e.which) && !q(b.target).is(e.not) && (!e.handle || q(b.target).closest(e.handle, b.currentTarget).length))
                if (e.propagates = 1,
                e.interactions = [k.interaction(this, e)],
                e.target = b.target,
                e.pageX = b.pageX,
                e.pageY = b.pageY,
                e.dragging = null,
                a = k.hijack(b, "draginit", e),
                e.propagates) {
                    if ((a = k.flatten(a)) && a.length)
                        e.interactions = [],
                        q.each(a, function() {
        ...
        handler: function(b) {
            ...
            case !e.dragging && "mousemove":
                if (Math.pow(b.pageX - e.pageX, 2) + Math.pow(b.pageY - e.pageY, 2) < Math.pow(e.distance, 2))
                    break;
                b.target = e.target;
            ...
            case "mouseup":
                u.remove(document, "mousemove mouseup", k.handler),
                e.dragging && (!1 !== e.drop && x.drop && x.drop.handler(b, e),
                k.hijack(b, "dragend", e)),
                k.textselect(!0),
                !1 === e.click && e.dragging && (jQuery.event.triggered = !0,
                setTimeout(function() {
        ...
        delegate: function(b) {
            var e = [], a, c = q.data(this, "events") || {};
            q.each(c.live || [], function(c, h) {
                if (0 === h.preType.indexOf("drag") && (a = q(b.target).closest(h.selector, b.currentTarget)[0]))
                    u.add(a, h.origType + "." + k.livekey, h.origHandler, h.data),
                    0 > q.inArray(a, e) && e.push(a)
            });
        ...
        hijack: function(b, e, a, c, d) {
            if (a) {
                var h = b.originalEvent, f = b.type, j = e.indexOf("drop") ? "drag" : "drop", l, g = c || 0, w, r;
                c = !isNaN(c) ? c : a.interactions.length;
                b.type = e;
                b.originalEvent = null;
                a.results = [];
                do
                    if ((w = a.interactions[g]) && !("dragend" !== e && w.cancelled))
                        r = k.properties(b, a, w),
                        w.results = [],
                        q(d || w[j] || a.droppable).each(function(c, d) {
                            r.target = d;
                            l = u.handle ? d ? u.handle.call(d, b, r) : null : d ? u.dispatch.call(d, b, r) : null;
                            !1 === l ? ("drag" == j && (w.cancelled = !0,
                            a.propagates -= 1),
                            "drop" == e && (w[j][c] = null)) : "dropinit" == e && w.droppable.push(k.element(l) || d);
                        ...
                        a.results[g] = k.flatten(w.results),
                        "dropinit" == e && (w.droppable = k.flatten(w.droppable)),
                        "dragstart" == e && !w.cancelled && r.update();
                while (++g < c);b.type = f;
                b.originalEvent = h;
        ...
        textselect: function(b) {
            q(document)[b ? "unbind" : "bind"]("selectstart", k.dontstart).attr("unselectable", b ? "off" : "on").css("MozUserSelect", b ? "" : "none")
        },
        dontstart: function() {
            return !1
        },
    ...
    z.fn.html5boxTransition = function(b, e, a, c, d) {
        ...
        var h = c.easing
          ...
          , l = null;
        b && (b = b.split(","),
        l = b[Math.floor(Math.random() * b.length)],
        l = z.trim(l.toLowerCase()));
        l && c[l] && ("duration"in c[l] && (f = c[l].duration),
        c[l].easing && (h = c[l].easing));
        "fade" == l || "fadein" == l ? (a.hide(),
        e.insertBefore(a),
        a.fadeIn(f, h, function() {
            e.remove();
            d()
        })) : "fadeout" == l ? (a.show(),
        e.fadeOut(f, h, function() {
            e.remove();
            d()
        })) : "fadeinout" == l ? (a.hide(),
        e.insertBefore(a),
    ...
    p.fn.addHTML5VideoControls = function(b, e, a, c, d, h, f, j, l, g, w, r) {
        ...
        var t = p("<div class='html5boxVideoPlay'></div>");
        m.after(t);
        t.css({
            position: "absolute",
            top: "90%",
        ...
        p(".html5boxVideoControlsBg", n).css({
            display: "block",
            position: "absolute",
            width: "100%",
            height: "100%",
        ...
        var W = p(".html5boxTimeCurrent", n)
          , Q = p(".html5boxTimeTotal", n)
          , D = p(".html5boxSeeker", n)
          , B = p(".html5boxSeekerPlay", n)
          , T = p(".html5boxSeekerBuffer", n)
          , ca = p(".html5boxSeekerHandler", n);
        W.css({
            display: "block",
            position: "relative",
            "float": "left",
        ...
        if (C.get(0).requestFullscreen || C.get(0).webkitRequestFullScreen || C.get(0).mozRequestFullScreen || C.get(0).webkitEnterFullScreen || C.get(0).msRequestFullscreen) {
            var R = function(a) {
                f ? a ? (m.get(0).setAttribute("controls", "controls"),
                j && m.get(0).setAttribute("controlsList", "nodownload")) : m.get(0).removeAttribute("controls") : a ? (p(document).on("mousemove", P),
                n.css({
                    "z-index": 2147483647,
                    position: "fixed"
                }),
            ...
            p(".html5boxFullscreen", n).css({
                ...
                (A = !A) ? (f && (m.get(0).setAttribute("controls", "controls"),
                j && m.get(0).setAttribute("controlsList", "nodownload")),
                C.get(0).requestFullscreen ? C.get(0).requestFullscreen() : C.get(0).webkitRequestFullScreen ? C.get(0).webkitRequestFullScreen() : C.get(0).mozRequestFullScreen ? C.get(0).mozRequestFullScreen() : C.get(0).webkitEnterFullScreen && C.get(0).webkitEnterFullScreen(),
                C.get(0).msRequestFullscreen && C.get(0).msRequestFullscreen()) : document.cancelFullScreen ? document.cancelFullScreen() : document.mozCancelFullScreen ? document.mozCancelFullScreen() : document.webkitCancelFullScreen ? document.webkitCancelFullScreen() : document.webkitExitFullscreen ? document.webkitExitFullscreen() : document.msExitFullscreen && document.msExitFullscreen()
            })
        }
        if (E)
            p(".html5boxHD", n).css({
        ...
        if (g) {
            ...
            Z.css({
                ...
                margin: Math.floor((s - 32) / 2),
                cursor: "pointer",
                "background-image": "url('" + b + "html5boxplayer_caption.png')",
                "background-position": r ? "right center" : "left center"
            }).data("showcaption", r).on("click", function() {
                var a = !Z.data("showcaption");
                Z.data("showcaption", a).css({
                    "background-position": (a ? "right" : "left") + " center"
                });
                if (m.get(0).textTracks)
                    for (var b = 0; b < m.get(0).textTracks.length; b++)
                        m.get(0).textTracks[b].mode = a ? "showing" : "hidden"
            })
        }
        m.get(0).volume = h;
        var da = 0 == h ? 1 : h;
        ...
        if (m.get(0).volume === a / 2 + 0.1) {
            m.get(0).volume = a;
            h = p(".html5boxVolume", n);
            var X = p(".html5boxVolumeButton", n)
              , $ = p(".html5boxVolumeBar", n)
              , M = p(".html5boxVolumeBarBg", n)
              , U = p(".html5boxVolumeBarActive", n);
            h.css({
                display: "block",
                position: "relative",
                "float": "right",
            ...
            X.css({
                ...
                0 < a ? (da = a,
                a = 0) : a = da;
                var b = p(this).css("background-position") ? p(this).css("background-position").split(" ")[1] : p(this).css("background-position-y");
                X.css({
            ...
            m.on("canplay", function() {
                if (g && m.get(0).textTracks) {
                    for (var a = 0; a < m.get(0).textTracks.length; a++) {
                        m.get(0).textTracks[a].mode = "hidden";
                        if (m.get(0).textTracks[a].activeCues)
                            for (var b = 0; b < m.get(0).textTracks[a].activeCues.length; b++)
                                m.get(0).textTracks[a].activeCues[b].line = w;
                        if (m.get(0).textTracks[a].cues)
                            for (b = 0; b < m.get(0).textTracks[a].cues.length; b++)
                                m.get(0).textTracks[a].cues[b].line = w
                    }
                    b = p(".html5boxCaption", n).data("showcaption");
                    for (a = 0; a < m.get(0).textTracks.length; a++)
                        m.get(0).textTracks[a].mode = b ? "showing" : "hidden"
                }
            }),
            m.on("play", b),
            m.on("pause", q),
    ...
    b.fn.html5gallery = function(k) {
        var e = function(a, c, d) {
            ...
            this.options.googlefonts && 0 < this.options.googlefonts.length && (a = "https://fonts.googleapis.com/css?family=" + this.options.googlefonts,
        ...
        e.prototype = {
            ...
            init: function(a) {
                ...
                if (a.options.frve || 0 < a.options.watermarklink.length)
                ...
                if (!(0 >= a.elemArray.length)) {
                    ...
                    a.slideRun(d);
                    a.firstrun = !1;
                    if (a.options.responsive && (a.resizeGallery(),
                    b(window).resize(function() {
                        setTimeout(function() {
                            a.resizeGallery()
                        }, a.options.resizedelay)
                    }),
                    a.options.isMobile && !a.options.mobileresizeevent))
            ...
            createSocial: function(a) {
                ...
                if (this.options.showsocial) {
                    ...
                    a ? b(".html5gallery-fullscreen-box-" + this.id, this.$fullscreen).append(d) : (b(".html5gallery-box-" + this.id, this.$gallery).append(d),
                    "mouseover" == this.options.socialmode && b(".html5gallery-box-" + this.id).hover(function() {
            ...
            checkMK: function() {
                if (this.options.frve) {
                    ...
                    if (0 > a.text().indexOf(this.options.frvem) || 0 > c.length)
                        a.append("<a style='text-decoration:none;' target='_blank' href='" + this.options.freelink + "' ><div style='display:block;visibility:visible;position:absolute;top:10px;left:10px;width:170px;height:18px;line-height:18px;text-align:center;border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;background-color:#fff;color:#333;font-size:12px;font-family:Arial,Helvetica,sans-serif;'>" + this.options.frvem + "</div></a>");
            ...
            initData: function(a) {
                ...
                if (this.options.src && 0 < this.options.src.length) {
                    ...
                    this.options.remote && 0 < this.options.remote.length ? (d = this,
                    b.getJSON(this.options.remote, function(b) {
                    ...
                    c = "https://gdata.youtube.com/feeds/api/videos?" + b.param(c),
                    d = this,
                    b.getJSON(c, function(b) {
                        ...
                        d.readTags();
                        a(d)
                    })) : this.options.youtubeapikey && this.options.youtubeplaylistid ? (d = this,
            ...
            readTags: function() {
                ...
                (b("img.html5galleryimg", this.container).length ? b("img.html5galleryimg", this.container) : b("img", this.container)).each(function() {
                    ...
                    var l = a.options.width
                      ...
                      , N = null
                      , m = !1
                      , t = b(this).closest("a.html5galleryimglink");
                    0 >= t.length && (t = b(this).parent());
                    t.is("a") && (d = t.attr("href"),
                    k = t.data("ogg"),
                    p = t.data("webm"),
                    q = t.data("link"),
                    s = t.data("linktarget"),
                    u = t.data("poster"),
                    isNaN(t.data("width")) || (l = t.data("width")),
                    isNaN(t.data("height")) || (g = t.data("height")),
                    v = t.data("hd"),
                    y = t.data("hdogg"),
                    x = t.data("hdwebm"),
                    A = t.data("lightboxwidth"),
                    z = t.data("lightboxheight"),
                    H = t.data("youtubeapikey"),
                    E = t.data("youtubeplaylistid"),
                    N = t.data("youtubeplaylistmaxresults"),
                    m = t.hasClass("html5gallerylightbox"));
                ...
                b.getJSON(g, function(b) {
                    if (b && b.items)
                        for (var g = 0; g < b.items.length; g++) {
                            ...
                            0 <= e ? (j.elemArray.splice(e, 0, l),
                            e++) : j.elemArray.push(l)
                        }
                    b && (b.nextPageToken && d && 50 < d) && (w = !1,
                    j.getYouTubePlaylist(a, c, d - 50, e, f, j, b.nextPageToken))
                }).always(function() {
                    w && f(j)
                })
            },
            processElemArray: function(a) {
                for (var b = !1, d = 0; d < a.elemArray.length; d++)
                    a.elemArray[d][25] || (a.elemArray[d][25] = a.elemArray[d][7]);
            ...
            createMarkup: function() {
                ...
                b.getScript("https://ssl.google-analytics.com/ga.js"))
            },
            createSocialMedia: function() {
                ...
                c = this.options.twitterurl && 0 < this.options.twitterurl.length ? c + (" data-url='" + this.options.twitterurl + "'") : c + (" data-url='" + a + "'"),
                this.options.twitterusername && 0 < this.options.twitterusername.length && (c += " data-via='" + this.options.twittervia + "' data-related='" + this.options.twitterusername + "'"),
                b(".html5gallery-viral-" + this.id, this.$gallery).append(c + ">Tweet</a></div>"),
                ...
                c = this.options.googleplusurl && 0 < this.options.googleplusurl.length ? c + (" data-href='" + this.options.googleplusurl + "'") : c + (" data-href='" + a + "'"),
                b(".html5gallery-viral-" + this.id, this.$gallery).append(c + "></div></div>"),
                b.getScript("https://apis.google.com/js/plusone.js"))
            },
            ...
            updateTimer: function(a) {
                this.isFullscreen ? (a = Math.max(0, Math.floor(b(".html5gallery-fullscreen-elem-wrapper-" + this.id, this.$fullscreen).width() * a)),
                b(".html5gallery-fullscreen-timer-" + this.id, this.$fullscreen).css({
                    width: a + "px"
                })) : (a = Math.max(0, Math.floor(b(".html5gallery-elem-" + this.id, this.$gallery).width() * a)),
                b(".html5gallery-timer-" + this.id, this.$gallery).css({
                    width: a + "px"
                }))
            },
            createEvents: function() {
                ...
                if (!("ontouchstart"in window) || !a.options.disablehovereventontouch)
                    b(".html5gallery-box-" + this.id, this.$gallery).mousemove(function() {
                        ...
                        if (a.options.titleoverlay && a.options.titleautohide && (!a.options.hidetitlewhenvideoisplaying || !a.isVideoPlaying))
                            b(".html5gallery-title-" + a.id, a.$gallery).show(),
                            clearTimeout(a.hideTitleTimeout),
                    ...
                    b(".html5gallery-box-" + this.id, this.$gallery).hover(function() {
                        ...
                        if (a.options.titleoverlay && a.options.titleautohide && (!a.options.hidetitlewhenvideoisplaying || !a.isVideoPlaying))
                            b(".html5gallery-title-" + a.id, a.$gallery).fadeIn(),
                            clearTimeout(a.hideTitleTimeout),
                            a.hideTitleTimeout = setTimeout(function() {
                                b(".html5gallery-title-" + a.id, a.$gallery).fadeOut()
                            }, 3E3)
                ...
                b(".html5gallery-car-left-" + this.id, this.$gallery).click(function() {
                    b(this).data("disabled") || (a.disableupdatecarousel = !0,
                ...
                if ("vertical" == this.options.skin || "verticallight" == this.options.skin || "showcase" == this.options.skin || "verticalwithleft" == this.options.skin || "verticallightwithleft" == this.options.skin)
                    b(".html5gallery-car-list-" + this.id, this.$gallery).on("DOMMouseScroll mousewheel wheel", function(c) {
                        ...
                        if (!(e < a.options.thumbMaskHeight)) {
                            var e = -1 * (e - a.options.thumbMaskHeight)
                              , f = 0;
                            c.originalEvent && (c.originalEvent.wheelDeltaY ? f = c.originalEvent.wheelDeltaY : c.originalEvent.detail ? f = -20 * c.originalEvent.detail : c.originalEvent.wheelDelta ? f = c.originalEvent.wheelDelta : c.originalEvent.deltaY && (f = a.options.isFirefox ? -10 * c.originalEvent.deltaY : -1 * c.originalEvent.deltaY));
                ...
                "ontouchstart"in window && ("vertical" == this.options.skin || "verticallight" == this.options.skin || "showcase" == this.options.skin || "verticalwithleft" == this.options.skin || "verticallightwithleft" == this.options.skin ? b(".html5gallery-car-" + this.id, this.$gallery).touchSwipe({
                    preventWebBrowser: !0,
                    swipeTop: function() {
            ...
            resizeStyleVertical: function() {
                if (this.container.parent() && this.container.parent().width()) {
                    ...
                    if (this.options.carouselposresponsive) {
                        ...
                        a < this.options.carouselposresponsiveonscreenwidth ? this.options.carouselposition = "bottom" : (this.options.carouselposition = this.options.originalcarouselposition,
                    ...
                    this.options.responsivefullscreen && 0 < this.container.parent().height() ? (this.options.containerHeight = this.container.parent().height(),
                    ...
                    this.options.totalHeight = "bottom" == this.options.carouselposition ? this.options.height + this.options.headerHeight + 2 * this.options.padding + this.options.carouselmargin + this.options.carouselHeight : this.options.height + this.options.headerHeight + 2 * this.options.padding,
                    ...
                    this.options.showcarousel && ("bottom" == this.options.carouselposition ? (this.options.carouselWidth = this.options.width,
                    ...
                    this.options.carouselSlider && (this.options.thumbwidth -= 20)) : (this.options.carouselWidth = this.options.thumbwidth,
                    ...
                    "left" == this.options.carouselposition ? (this.options.boxLeft = this.options.padding + this.options.carouselWidth + this.options.carouselmargin,
                    this.options.carouselLeft = this.options.padding) : this.options.carouselLeft = this.options.padding + this.options.width + this.options.carouselmargin,
                    ...
                    a = this.options.thumbwidth - 3 * this.options.thumbmargin,
                    ...
                    if (1 == a || this.showingPoster) {
                        var c = this.showingPoster ? this.elemArray[this.curElem][23] : this.elemArray[this.curElem][10], d = this.showingPoster ? this.elemArray[this.curElem][24] : this.elemArray[this.curElem][11], e;
                        this.isFullscreen ? (a = this.elemArray[this.curElem][17] ? Math.min(this.elemArray[this.curElem][17], this.fullscreenWidth) : this.fullscreenWidth,
                        e = this.elemArray[this.curElem][18] ? Math.min(this.elemArray[this.curElem][18], this.fullscreenHeight) : this.fullscreenHeight,
                        e = Math.min(a / c, e / d),
                        e = 1 < e ? 1 : e) : e = "fill" == this.options.resizemode ? Math.max(this.options.width / c, this.options.height / d) : Math.min(this.options.width / c, this.options.height / d);
                        a = Math.round(e * c);
                        e = Math.round(e * d);
                    ...
                    } else if (12 == a || 5 == a || 6 == a || 7 == a || 8 == a || 9 == a || 10 == a || 11 == a)
                        ...
                        d = Math.round(e * d),
                        c = Math.round(e * c),
                        this.adjustFullscreen(d, c, !0)) : (d = this.options.width,
                        ...
                        b("#html5gallery-elem-video-" + this.id).attr("width", d),
                        b("#html5gallery-elem-video-" + this.id).attr("height", c),
                        b(".html5gallery-elem-video-" + this.id).find("iframe").attr("width", d),
                        b(".html5gallery-elem-video-" + this.id).find("iframe").attr("height", c),
                        b("#html5gallery-elem-video-" + this.id).find("iframe").attr("width", d),
                        b("#html5gallery-elem-video-" + this.id).find("iframe").attr("height", c),
                        b(".html5gallery-elem-iframe-" + this.id).css({
                            width: d + "px",
                            height: c + "px"
                        }),
                        b(".html5gallery-elem-iframe-" + this.id).find("iframe").attr("width", d),
                        b(".html5gallery-elem-iframe-" + this.id).find("iframe").attr("height", c);
                    e = d = 0;
                    "bottom" == this.options.headerpos && (d = this.options.titleoverlay ? this.options.height - this.options.titleheight : this.options.height,
                    e = this.options.titleoverlay ? this.options.height : this.options.height + this.options.titleheight);
                    ...
                    this.options.carouselSlider && (this.options.carouselSliderMin = 0,
                    ...
                    a = 0,
                    this.options.carouselNavButton && (a = Math.round(this.options.carAreaLength / 2 - this.options.thumbMaskHeight / 2)),
                    b(".html5gallery-car-mask-" + this.id).css({
                        top: a + "px",
                        height: this.options.thumbMaskHeight + "px"
                    }),
            ...
            createStyleVertical: function() {
                ...
                "left" == this.options.carouselposition ? (this.options.boxLeft = this.options.padding + this.options.carouselWidth + this.options.carouselmargin,
                this.options.carouselLeft = this.options.padding) : this.options.carouselLeft = this.options.padding + this.options.width + this.options.carouselmargin,
                this.options.carouselTop = this.options.padding) : (this.options.carouselWidth = 0,
                this.options.carouselHeight = 0,
                this.options.carouselLeft = 0,
                this.options.carouselTop = 0,
                this.options.carouselmargin = 0);
                "bottom" == this.options.carouselposition ? (this.options.totalWidth = this.options.width + 2 * this.options.padding,
                this.options.totalHeight = this.options.height + this.options.headerHeight + 2 * this.options.padding + this.options.carouselmargin + this.options.carouselHeight) : (this.options.totalWidth = this.options.width + this.options.carouselWidth + this.options.carouselmargin + 2 * this.options.padding,
                this.options.totalHeight = this.options.height + this.options.headerHeight + 2 * this.options.padding);
                ...
                "top" == this.options.headerpos ? (c = 0,
                a = this.options.socialheight,
                this.options.elemTop = this.options.headerHeight) : "bottom" == this.options.headerpos ? (this.options.elemTop = 0,
                a = this.options.titleoverlay ? this.options.height - this.options.titleheight : this.options.height,
                c = this.options.titleoverlay ? this.options.height : this.options.height + this.options.titleheight) : "bottomoutside" == this.options.headerpos && (a = this.options.showcarousel ? this.options.height + this.options.carouselHeight : this.options.height);
                ...
                var d = d + (" .html5gallery-box-" + this.id + " {display:block; position:absolute; text-align:center; left:" + this.options.boxLeft + "px; top:" + this.options.boxTop + "px; width:" + this.options.boxWidth + "px; height:" + this.options.boxHeight + "px; }")
                  ...
                  , d = d + (" .html5gallery-title-" + this.id + " {display:" + (this.options.titleoverlay && this.options.titleautohide ? "none" : "block") + "; overflow:hidden; position:absolute; left:100px; width:" + c + "px; ")
                ...
                this.options.isIE7 || this.options.isIE6 ? (d += " .html5gallery-loading-" + this.id + " {display:none; }",
                d += " .html5gallery-loading-center-" + this.id + " {display:none; }") : (d += " .html5gallery-loading-" + this.id + " {display:block; position:absolute; top:4px; right:4px; width:100%; height:100%; background:url('" + this.options.skinfolder + "loading.gif') no-repeat top right;}",
                ...
                this.options.slideshadow && (d += " .html5gallery-title-" + this.id + " { padding:4px;}",
                d += " .html5gallery-timer-" + this.id + " { margin:4px;}",
                ...
                this.options.showcarousel ? (d += " .html5gallery-car-" + this.id + " { position:absolute; display:block; overflow:hidden; width:" + this.options.carouselWidth + "px; height:" + this.options.carouselHeight + "px; left:" + this.options.carouselLeft + "px; top:" + this.options.carouselTop + "px; }",
                d += " .html5gallery-car-list-" + this.id + " { position:absolute; display:block; overflow:hidden; top:" + this.options.carTop + "px; height:" + String(this.options.carAreaLength) + "px; left:0px; width:" + this.options.carouselWidth + "px; }",
                d += ".html5gallery-thumbs-" + this.id + " {margin-top:0px; height:" + String(this.elemArray.length * (this.options.thumbheight + this.options.thumbgap)) + "px;}",
                this.options.thumbShowNum = Math.floor(this.options.carAreaLength / (this.options.thumbheight + this.options.thumbgap)),
                1 > this.options.thumbShowNum && (this.options.thumbShowNum = 1),
                this.options.thumbMaskHeight = this.options.thumbShowNum * this.options.thumbheight + (this.options.thumbShowNum - 1) * this.options.thumbgap,
                this.options.thumbTotalHeight = this.elemArray.length * this.options.thumbheight + (this.elemArray.length - 1) * this.options.thumbgap,
                ...
                this.options.carouselSliderMax = this.options.thumbMaskHeight - 54,
                d += " .html5gallery-car-slider-bar-" + this.id + " { position:absolute; display:" + (this.options.carouselSlider ? "block" : "none") + "; overflow:hidden; top:0px; height:" + this.options.thumbMaskHeight + "px; left:" + String(this.options.thumbwidth + 6) + "px; width:14px;}",
                d += " .html5gallery-car-slider-bar-top-" + this.id + " { position:absolute; display:block; top:0px; left:0px; width:14px; height:16px; background:url('" + this.options.skinfolder + "bartop.png')}",
                d += " .html5gallery-car-slider-bar-middle-" + this.id + " { position:absolute; display:block; top:16px; left:0px; width:14px; height:" + String(this.options.thumbMaskHeight - 32) + "px; background:url('" + this.options.skinfolder + "bar.png')}",
                d += " .html5gallery-car-slider-bar-bottom-" + this.id + " { position:absolute; display:block; bottom:0px; left:0px; width:14px; height:16px; background:url('" + this.options.skinfolder + "barbottom.png')}",
                d = this.options.isMobile || this.isTouch && this.options.splitvsliderontouch ? d + (" .html5gallery-car-left-" + this.id + " { position:absolute; display:" + (this.options.carouselSlider ? "block" : "none") + "; cursor:pointer; overflow:hidden; width:16px; height:35px; left:" + String(this.options.thumbwidth + 5) + "px; top:0px; background:url('" + this.options.skinfolder + "slidertop.png')}  .html5gallery-car-right-" + this.id + " { position:absolute; display:" + (this.options.carouselSlider ? "block" : "none") + "; cursor:pointer; overflow:hidden; width:16px; height:35px; left:" + String(this.options.thumbwidth + 5) + "px; top:" + String(this.options.thumbMaskHeight - 35) + "px; background:url('" + this.options.skinfolder + "sliderbottom.png')} ") : d + (" .html5gallery-car-slider-" + this.id + " { position:absolute; display:" + (this.options.carouselSlider ? "block" : "none") + "; overflow:hidden; cursor:pointer; top:0px; height:54px; left:" + String(this.options.thumbwidth + 5) + "px; width:16px; background:url('" + this.options.skinfolder + "slider.png');}"),
                a = 0,
                this.options.carouselNavButton && (a = Math.round(this.options.carAreaLength / 2 - this.options.thumbMaskHeight / 2)),
                d += " .html5gallery-car-mask-" + this.id + " { position:absolute; display:block; overflow:hidden; top:" + a + "px; height:" + this.options.thumbMaskHeight + "px; left:0px; width:" + this.options.thumbwidth + "px;} ",
                a = this.options.thumbheight,
                this.options.isIE || (a = this.options.thumbheight - 2),
                d += " .html5gallery-tn-" + this.id + " { display:block; margin-bottom:" + this.options.thumbgap + "px; text-align:center; cursor:pointer; width:" + this.options.thumbwidth + "px;height:" + a + "px;overflow:hidden;",
                this.options.carouselbgtransparent ? d += "background-color:transparent;" : (this.options.isIE || (d += "border-top:1px solid " + this.options.carouseltopborder + "; border-bottom:1px solid " + this.options.carouselbottomborder + ";"),
                ...
                this.options.carouselbgimage && (d += "background:url('" + this.options.skinfolder + this.options.carouselbgimage + "') center top;"),
                d = d + "}" + (" .html5gallery-tn-selected-" + this.id + " { display:block; margin-bottom:" + this.options.thumbgap + "px;text-align:center; cursor:pointer; width:" + this.options.thumbwidth + "px;height:" + a + "px;overflow:hidden;"),
                this.options.carouselbgtransparent ? d += "background-color:transparent;" : (this.options.isIE || (d += "border-top:1px solid " + this.options.carouselhighlighttopborder + "; border-bottom:1px solid " + this.options.carouselhighlightbottomborder + ";"),
                ...
                this.options.carouselbgimage && (d += "background:url('" + this.options.skinfolder + this.options.carouselbgimage + "') center top;"),
                d += "}",
                d += " .html5gallery-tn-selected-" + this.id + " .html5gallery-tn-img-" + this.id + " {background-color:" + this.options.thumbimagebordercolor + ";} .html5gallery-tn-" + this.id + " { filter:alpha(opacity=" + Math.round(100 * this.options.thumbopacity) + "); opacity:" + this.options.thumbopacity + "; }  .html5gallery-tn-selected-" + this.id + " { filter:alpha(opacity=100); opacity:1; } ",
                c = this.options.thumbwidth - 3 * this.options.thumbmargin,
                this.options.thumbshowimage ? (c -= this.options.thumbimagewidth + 2 * this.options.thumbimageborder,
                a = this.options.thumbshowtitle ? this.options.thumbmargin : this.options.thumbwidth / 2 - (this.options.thumbimagewidth + 2 * this.options.thumbimageborder) / 2,
                e = Math.round((this.options.thumbheight - 2) / 2 - (this.options.thumbimageheight + 2 * this.options.thumbimageborder) / 2),
                d += " .html5gallery-tn-img-" + this.id + " {display:block; overflow:hidden; float:left; margin-top:" + e + "px; margin-left:" + a + "px; width:" + String(this.options.thumbimagewidth + 2 * this.options.thumbimageborder) + "px;height:" + String(this.options.thumbimageheight + 2 * this.options.thumbimageborder) + "px;}") : d += " .html5gallery-tn-img-" + this.id + " {display:none;}",
                this.options.thumbshowtitle ? (d += " .html5gallery-tn-title-" + this.id + " {display:block; overflow:hidden; float:left; margin-top:0px; margin-left:" + this.options.thumbmargin + "px; width:" + c + "px;height:" + String(this.options.thumbheight - 2) + "px;" + (this.options.thumbshowdescription ? "" : "line-height:" + String(this.options.thumbheight - 2) + "px;") + "}",
                d += " .html5gallery-tn-title-" + this.id + this.options.thumbtitlecss,
                d += " .html5gallery-tn-description-" + this.id + this.options.thumbdescriptioncss) : (d += " .html5gallery-tn-title-" + this.id + " {display:none;}",
                d += " .html5gallery-tn-description-" + this.id + " {display:none;}"),
                this.carouselHighlight = function(a) {
                ...
                this.carouselBarClicked = function(a) {
                    ...
                    a.pageY > b(".html5gallery-car-slider-" + this.id, this.$gallery).offset().top ? (a = -1 * parseInt(c.css("margin-top")) + this.options.thumbShowNum * (this.options.thumbheight + this.options.thumbgap),
                    a >= this.options.thumbTotalHeight - this.options.thumbMaskHeight && (a = this.options.thumbTotalHeight - this.options.thumbMaskHeight)) : (a = -1 * parseInt(c.css("margin-top")) - this.options.thumbShowNum * (this.options.thumbheight + this.options.thumbgap),
                    0 > a && (a = 0));
                    c.stop(!0).animate({
                        marginTop: -a
                    }, 500);
            ...
            createImageToolbox: function() {
                ...
                if ("never" != this.options.showimagetoolbox) {
                    ...
                    if ("center" == this.options.imagetoolboxstyle)
                        ...
                        a += " .html5gallery-toolbox-bg-" + this.id + " {display:block; left:0px; top:0px; width:100%; height:100%; position:absolute; filter:alpha(opacity=60); opacity:0.6; background-color:#222222; }",
                        a += " .html5gallery-toolbox-buttons-" + this.id + " {display:block; margin:0px auto; height:100%;}",
                        a += " .html5gallery-play-" + this.id + " { position:relative; float:left; display:" + ("show" == this.options.imagetoolboxmode ? "block" : "none") + "; cursor:pointer; overflow:hidden; width:32px; height:32px; margin-left:2px; margin-right:2px; margin-top:" + Math.round(4) + "px; background:url('" + this.options.skinfolder + "play.png') no-repeat top left; } ",
                        a += " .html5gallery-pause-" + this.id + " { position:relative; float:left; display:" + ("show" == this.options.imagetoolboxmode ? "block" : "none") + "; cursor:pointer; overflow:hidden; width:32px; height:32px; margin-left:2px; margin-right:2px; margin-top:" + Math.round(4) + "px; background:url('" + this.options.skinfolder + "pause.png') no-repeat top left; } ",
                        a += " .html5gallery-left-" + this.id + " { position:relative; float:left; display:" + ("show" == this.options.imagetoolboxmode ? "block" : "none") + "; cursor:pointer; overflow:hidden; width:32px; height:32px; margin-left:2px; margin-right:2px; margin-top:" + Math.round(4) + "px; background:url('" + this.options.skinfolder + "prev.svg') no-repeat top left; } ",
                        a += " .html5gallery-right-" + this.id + "{position:relative;float:left;display:" + ("show"==this.options.imagetoolboxmode?"block":"none")+";cursor:pointer;overflow:hidden;width:32px;height:32px;margin-left:2px;margin-right:2px;margin-top:"+Math.round(4)+"px; background:url('"+this.options.skinfolder+"next.svg')no-repeat top left;} ",
                        a += " .html5gallery-lightbox-" + this.id + " {position:relative; float:left; display:" + ("show" == this.options.imagetoolboxmode ? "block" : "none") + "; cursor:pointer; overflow:hidden; width:32px; height:32px; margin-left:2px; margin-right:2px; margin-top:" + Math.round(4) + "px; background:url('" + this.options.skinfolder + "lightbox.png') no-repeat top left; } ";
                    else {
                        ...
                        a += " .html5gallery-left-" + this.id + " { position:absolute; display:" + ("show" == this.options.imagetoolboxmode ? "block" : "none") + "; cursor:pointer;padding-bottom:304px;right:27px;width:48px;height:48px;background:url('" + this.options.skinfolder + "') no-repeat right bottom;} ";
                        a += " .html5gallery-right-" + this.id + " { position:absolute; display:" + ("show" == this.options.imagetoolboxmode ? "block" : "none") + ";cursor:pointer;padding-bottom:304px;left:" + e + "px; width:48px;height:48px;background:url('" + this.options.skinfolder + "')  no-repeat right bottom;} ";
                ...
                this.showimagetoolbox = function(a, c) {
                    if (this.options.showplaybutton || this.options.showprevbutton || this.options.shownextbutton || this.options.showfullscreenbutton) {
                        ...
                        if ("center" == this.options.imagetoolboxstyle) {
                            ...
                            e = 0;
                            this.options.showplaybutton && (1 == a || this.options.showplaypausefullscreenforall && (!this.options.hideplaypausefullscreenwhenvideoisplaying || !this.isVideoPlaying)) ? (e += 36,
                            this.isPaused ? (b(".html5gallery-play-" + this.id, this.$gallery).show(),
                            b(".html5gallery-pause-" + this.id, this.$gallery).hide()) : (b(".html5gallery-play-" + this.id, this.$gallery).hide(),
                            b(".html5gallery-pause-" + this.id, this.$gallery).show())) : (b(".html5gallery-play-" + this.id, this.$gallery).hide(),
                            b(".html5gallery-pause-" + this.id, this.$gallery).hide());
                            this.options.showprevbutton ? (e += 36,
                            b(".html5gallery-left-" + this.id, this.$gallery).show()) : b(".html5gallery-left-" + this.id, this.$gallery).hide();
                            this.options.shownextbutton ? (e += 36,
                            b(".html5gallery-right-" + this.id, this.$gallery).show()) : b(".html5gallery-right-" + this.id, this.$gallery).hide();
                            this.options.showfullscreenbutton && (1 == a || this.options.showplaypausefullscreenforall && (!this.options.hideplaypausefullscreenwhenvideoisplaying || !this.isVideoPlaying)) ? (e += 36,
                            b(".html5gallery-lightbox-" + this.id, this.$gallery).show()) : b(".html5gallery-lightbox-" + this.id, this.$gallery).hide();
                            b(".html5gallery-toolbox-" + this.id, this.$gallery).css({
                                width: e + 16
                            });
                            ...
                            this.options.showplaybutton && (1 == a || this.options.showplaypausefullscreenforall && (!this.options.hideplaypausefullscreenwhenvideoisplaying || !this.isVideoPlaying)) ? this.isPaused ? (b(".html5gallery-play-" + this.id, this.$gallery).show(),
                            b(".html5gallery-pause-" + this.id, this.$gallery).hide()) : (b(".html5gallery-play-" + this.id, this.$gallery).hide(),
                            b(".html5gallery-pause-" + this.id, this.$gallery).show()) : (b(".html5gallery-play-" + this.id, this.$gallery).hide(),
                            b(".html5gallery-pause-" + this.id, this.$gallery).hide()),
                            this.options.showprevbutton ? b(".html5gallery-left-" + this.id, this.$gallery).show() : b(".html5gallery-left-" + this.id, this.$gallery).hide(),
                            this.options.shownextbutton ? b(".html5gallery-right-" + this.id, this.$gallery).show() : b(".html5gallery-right-" + this.id, this.$gallery).hide(),
                            this.options.showfullscreenbutton && (1 == a || this.options.showplaypausefullscreenforall && (!this.options.hideplaypausefullscreenwhenvideoisplaying || !this.isVideoPlaying)) ? b(".html5gallery-lightbox-" + this.id, this.$gallery).show() : b(".html5gallery-lightbox-" + this.id, this.$gallery).hide();
            ...
            resizeStyleDefault: function() {
                if (this.container.parent() && this.container.parent().width()) {
                    ...
                    this.options.showcarousel && (this.options.carouselHeight = this.options.thumbheight + 2 * this.options.thumbmargin,
                    this.options.carouselmultirows ? ("samecolumn" == this.options.thumbresponsive ? (this.options.carouselcolumn = this.options.thumbcolumns,
                    this.options.thumbcolumnsresponsive && (a = b(window).width(),
                    ...
                    this.options.thumbshowtitle && (this.options.thumbheight += this.options.thumbtitleheight)) : (this.options.thumbcolumnsresponsive && (a = b(window).width(),
                    a < this.options.thumbsmallsize ? (this.options.thumbwidth = this.options.thumbsmallwidth,
                    this.options.thumbheight = this.options.thumbsmallheight,
                    this.options.thumbtitleheight = this.options.thumbsmalltitleheight) : a < this.options.thumbmediumsize ? (this.options.thumbwidth = this.options.thumbmediumwidth,
                    this.options.thumbheight = this.options.thumbmediumheight,
                    this.options.thumbtitleheight = this.options.thumbmediumtitleheight) : (this.options.thumbwidth = this.options.thumboriginalwidth,
                    ...
                    this.options.carouselHeight = Math.ceil(this.elemArray.length / this.options.carouselcolumn) * (this.options.thumbheight + this.options.thumbrowgap)) : this.options.thumbcolumnsresponsive && (a = b(window).width(),
                    a < this.options.thumbsmallsize ? (this.options.thumbwidth = this.options.thumbsmallwidth,
                    this.options.thumbheight = this.options.thumbsmallheight,
                    this.options.thumbtitleheight = this.options.thumbsmalltitleheight) : a < this.options.thumbmediumsize ? (this.options.thumbwidth = this.options.thumbmediumwidth,
                    this.options.thumbheight = this.options.thumbmediumheight,
                    ...
                    this.options.carouselLeft = this.options.padding,
                    this.options.carouselTop = "top" == this.options.carouselposition ? this.options.padding : this.options.padding + this.options.boxHeight + this.options.carouselmargin);
                    b(".html5gallery-container-" + this.id).css({
                        width: this.options.totalWidth + "px",
                        height: this.options.totalHeight + "px"
                    });
                    ...
                    if (1 == a || this.showingPoster) {
                        ...
                        if (this.isFullscreen)
                            ...
                            a = "fill" == this.options.resizemode ? Math.max(this.options.width / c, this.options.height / d) : Math.min(this.options.width / c, this.options.height / d);
                        ...
                        e = Math.round(a * d),
                        a = Math.round(a * c),
                        this.adjustFullscreen(e, a, !0)) : (e = this.options.width,
                        ...
                        b("#html5gallery-elem-video-" + this.id).attr("width", e),
                        b("#html5gallery-elem-video-" + this.id).attr("height", a),
                        b(".html5gallery-elem-video-" + this.id).find("iframe").attr("width", e),
                        b(".html5gallery-elem-video-" + this.id).find("iframe").attr("height", a),
                        b("#html5gallery-elem-video-" + this.id).find("iframe").attr("width", e),
                        b("#html5gallery-elem-video-" + this.id).find("iframe").attr("height", a),
                        b(".html5gallery-elem-iframe-" + this.id).css({
                            width: e + "px",
                        ...
                        b(".html5gallery-elem-iframe-" + this.id).find("iframe").attr("width", e),
                        b(".html5gallery-elem-iframe-" + this.id).find("iframe").attr("height", a);
                    e = a = 0;
                    "bottom" == this.options.headerpos ? (a = this.options.titleoverlay ? this.options.height - this.options.titleheight : this.options.height,
                    e = this.options.titleoverlay ? this.options.height : this.options.height + this.options.titleheight) : "bottomoutside" == this.options.headerpos && (a = this.options.showcarousel ? this.options.height + this.options.carouselHeight : this.options.height);
                    c = this.options.slideshadow ? this.options.boxWidth - 8 : this.options.boxWidth;
                    b(".html5gallery-title-" + this.id).css({
                        width: c + "px"
                    });
                    ...
                    if (this.options.showcarousel) {
                        ...
                        }) : (a = Math.floor(this.options.width / (this.options.thumbwidth + this.options.thumbgap)),
                        1 > a && (a = 1),
                        e = (this.options.width - a * this.options.thumbwidth - (a - 1) * this.options.thumbgap) / 2,
                        ...
                        this.options.thumbTotalWidth = this.elemArray.length * this.options.thumbwidth + (this.elemArray.length - 1) * this.options.thumbgap,
                        e = 0,
                        this.options.thumbMaskWidth > this.options.thumbTotalWidth && (e = this.options.thumbMaskWidth / 2 - this.options.thumbTotalWidth / 2 - this.options.thumbgap / 2),
                        b(".html5gallery-car-" + this.id).css({
                            height: this.options.carouselHeight + "px"
                        }),
                        b(".html5gallery-car-list-" + this.id).css({
            ...
            createStyleDefault: function() {
                ...
                this.options.carouselLeft = this.options.padding,
                "top" == this.options.carouselposition ? (this.options.carouselTop = this.options.padding,
                this.options.boxTop = this.options.padding + this.options.carouselHeight + this.options.carouselmargin) : this.options.carouselTop = this.options.padding + this.options.boxHeight + this.options.carouselmargin,
                this.options.carouselmultirows && ("samecolumn" == this.options.thumbresponsive ? (this.options.carouselcolumn = this.options.thumbcolumns,
                this.options.thumbcolumnsresponsive && (a = b(window).width(),
                a < this.options.thumbsmallsize ? this.options.carouselcolumn = this.options.thumbsmallcolumns : a < this.options.thumbmediumsize && (this.options.carouselcolumn = this.options.thumbmediumcolumns)),
                this.options.thumbwidth = Math.min((this.options.width - this.options.thumbgap * (this.options.carouselcolumn - 1)) / this.options.carouselcolumn),
                ...
                this.options.thumbimagewidth = this.options.thumbwidth - 2 * this.options.thumbimageborder,
                this.options.thumbimageheight = this.options.thumbheight - 2 * this.options.thumbimageborder,
                this.options.thumbshowtitle && (this.options.thumbheight += this.options.thumbtitleheight)) : (this.options.carouselcolumn = Math.floor(this.options.width / (this.options.thumbwidth + this.options.thumbgap)),
                1 > this.options.carouselcolumn && (this.options.carouselcolumn = 1)),
                this.options.carouselHeight = Math.ceil(this.elemArray.length / this.options.carouselcolumn) * (this.options.thumbheight + this.options.thumbrowgap))) : (this.options.carouselWidth = 0,
                this.options.carouselHeight = 0,
                this.options.carouselLeft = 0,
                this.options.carouselTop = 0,
                this.options.carouselmargin = 0);
                ...
                var c = 0
                  , d = 0;
                this.options.elemTop = 0;
                "top" == this.options.headerpos ? (d = 0,
                c = this.options.socialheight,
                this.options.elemTop = this.options.headerHeight) : "bottom" == this.options.headerpos && (this.options.elemTop = 0,
                c = this.options.titleoverlay ? this.options.height - this.options.titleheight : this.options.height,
                d = this.options.titleoverlay ? this.options.height : this.options.height + this.options.titleheight);
                ...
                this.options.isIE7 || this.options.isIE6 ? (a += " .html5gallery-loading-" + this.id + " {display:none; }",
                a += " .html5gallery-loading-center-" + this.id + " {display:none; }") : (a += " .html5gallery-loading-" + this.id + " {display:block; position:absolute; top:4px; right:4px; width:100%; height:100%; background:url('" + this.options.loadinggif + "') no-repeat top right;}",
                a += " .html5gallery-loading-center-" + this.id + " {display:block; position:absolute; top:0px; left:0px; width:100%; height:100%; background:url('" + this.options.centerloadinggif + "') no-repeat center center;}");
                ...
                a += " .html5gallery-timer-" + this.id + " { margin:4px;}",
                ...
                this.options.showcarousel && this.options.carouselmultirows ? (a += " .html5gallery-car-" + this.id + " { position:absolute; display:block; overflow:hidden; left:" + this.options.carouselLeft + "px; top:" + this.options.carouselTop + "px; width:" + this.options.width + "px;",
                a = this.options.carouselbgtransparent ? a + "background-color:transparent;" : a + ("border-top:1px solid " + this.options.carouseltopborder + ";border-bottom:1px solid " + this.options.carouselbottomborder + ";background-color: " + this.options.carouselbgcolorend + "; background: " + this.options.carouselbgcolorend + " -webkit-gradient(linear, left top, left bottom, from(" + this.options.carouselbgcolorstart + "), to(" + this.options.carouselbgcolorend + ")) no-repeat; background: " + this.options.carouselbgcolorend + " -moz-linear-gradient(top, " + this.options.carouselbgcolorstart + ", " + this.options.carouselbgcolorend + ") no-repeat; filter: progid:DXImageTransform.Microsoft.gradient(startColorstr=" + this.options.carouselbgcolorstart + ", endColorstr=" + this.options.carouselbgcolorend + ") no-repeat; -ms-filter: 'progid:DXImageTransform.Microsoft.gradient(startColorstr=" + this.options.carouselbgcolorstart + ", endColorstr=" + this.options.carouselbgcolorend + ")' no-repeat;"),
                this.options.carouselbgimage && (a += "background:url('" + this.options.skinfolder + this.options.carouselbgimage + "') center top;"),
                c = Math.floor(this.options.width / (this.options.thumbwidth + this.options.thumbgap)),
                1 > c && (c = 1),
                c = (this.options.width - c * this.options.thumbwidth - (c - 1) * this.options.thumbgap) / 2,
                a = a + "}" + (".html5gallery-thumbs-" + this.id + " { position:relative; display:block; margin-left:" + c + "px; width:" + ("samecolumn" == this.options.thumbresponsive ? (this.options.thumbwidth + this.options.thumbgap) * this.options.carouselcolumn : this.options.width) + "px; top:0px; }"),
                a += " .html5gallery-tn-" + this.id + " { display:block; float:left; margin-left:0px; margin-right:" + this.options.thumbgap + "px; margin-bottom:" + this.options.thumbrowgap + "px; text-align:center; cursor:pointer; width:" + this.options.thumbwidth + "px;height:" + this.options.thumbheight + "px;overflow:hidden;}",
                this.options.thumbshadow && (a += " .html5gallery-tn-" + this.id + " { -moz-box-shadow: 0px 2px 5px #aaa; -webkit-box-shadow: 0px 2px 5px #aaa; box-shadow: 0px 2px 5px #aaa;}"),
                a += " .html5gallery-tn-selected-" + this.id + " { display:block; float:left; margin-left:0px; margin-right:" + this.options.thumbgap + "px; margin-bottom:" + this.options.thumbrowgap + "px; text-align:center; cursor:pointer; width:" + this.options.thumbwidth + "px;height:" + this.options.thumbheight + "px;overflow:hidden;}",
                this.options.thumbshadow && (a += " .html5gallery-tn-selected-" + this.id + " { -moz-box-shadow: 0px 2px 5px #aaa; -webkit-box-shadow: 0px 2px 5px #aaa; box-shadow: 0px 2px 5px #aaa;}"),
                a += " .html5gallery-tn-" + this.id + " {background-color:" + this.options.thumbimagebordercolor + ";} .html5gallery-tn-" + this.id + " { filter:alpha(opacity=" + Math.round(100 * this.options.thumbopacity) + "); opacity:" + this.options.thumbopacity + "; }  .html5gallery-tn-selected-" + this.id + " { filter:alpha(opacity=100); opacity:1; } ",
                a += " .html5gallery-tn-img-" + this.id + " {display:block; overflow:hidden; width:" + String(this.options.thumbimagewidth + 2 * this.options.thumbimageborder) + "px;height:" + String(this.options.thumbimageheight + 2 * this.options.thumbimageborder) + "px;}",
                this.options.thumbunselectedimagebordercolor && (a += " .html5gallery-tn-selected-" + this.id + " {background-color:" + this.options.thumbunselectedimagebordercolor + ";}"),
                this.options.thumbshowtitle ? (a += " .html5gallery-tn-title-" + this.id + " {display:block; overflow:hidden; float:top; height:" + this.options.thumbtitleheight + "px;width:" + String(this.options.thumbwidth - 2) + "px;}",
                a += " .html5gallery-tn-title-" + this.id + this.options.thumbtitlecss) : a += " .html5gallery-tn-title-" + this.id + " {display:none;}",
                this.carouselHighlight = function() {}
                ) : this.options.showcarousel ? (a += " .html5gallery-car-" + this.id + " { position:absolute; display:block; overflow:hidden; left:" + this.options.carouselLeft + "px; top:" + this.options.carouselTop + "px; width:" + this.options.width + "px; height:" + this.options.carouselHeight + "px;",
                a = this.options.carouselbgtransparent ? a + "background-color:transparent;" : a + ("border-top:1px solid " + this.options.carouseltopborder + ";border-bottom:1px solid " + this.options.carouselbottomborder + ";background-color: " + this.options.carouselbgcolorend + "; background: " + this.options.carouselbgcolorend + " -webkit-gradient(linear, left top, left bottom, from(" + this.options.carouselbgcolorstart + "), to(" + this.options.carouselbgcolorend + ")) no-repeat; background: " + this.options.carouselbgcolorend + " -moz-linear-gradient(top, " + this.options.carouselbgcolorstart + ", " + this.options.carouselbgcolorend + ") no-repeat; filter: progid:DXImageTransform.Microsoft.gradient(startColorstr=" + this.options.carouselbgcolorstart + ", endColorstr=" + this.options.carouselbgcolorend + ") no-repeat; -ms-filter: 'progid:DXImageTransform.Microsoft.gradient(startColorstr=" + this.options.carouselbgcolorstart + ", endColorstr=" + this.options.carouselbgcolorend + ")' no-repeat;"),
                this.options.carouselbgimage && (a += "background:url('" + this.options.skinfolder + this.options.carouselbgimage + "') center top;"),
                a += "}",
                a += " .html5gallery-car-list-" + this.id + " { position:absolute; display:block; overflow:hidden; left:4px; width:" + String(this.options.width - 4 - 4) + "px; top:0px; height:" + this.options.carouselHeight + "px; }",
                this.options.carouselNavButton = !1,
                Math.floor((this.options.width - 4 - 4) / (this.options.thumbwidth + this.options.thumbgap)) < this.elemArray.length && (this.options.carouselNavButton = !0),
                a += " .html5gallery-car-left-" + this.id + " { position:absolute; overflow:hidden; width:" + this.options.carouselarrowwidth + "px; height:" + this.options.carouselarrowheight + "px; left:0px; top:" + String(this.options.carouselHeight / 2 - this.options.carouselarrowheight / 2) + "px; background:url('" + this.options.skinfolder + "carousel_left.png') no-repeat 0px 0px;}  .html5gallery-car-right-" + this.id + " { position:absolute; overflow:hidden; width:" + this.options.carouselarrowwidth + "px; height:" + this.options.carouselarrowheight + "px; right:0px; top:" + String(this.options.carouselHeight / 2 - this.options.carouselarrowheight / 2) + "px; background:url('" + this.options.skinfolder + "carousel_right.png') no-repeat 0px 0px;} ",
                c = this.options.carouselNavButton ? 2 * this.options.carouselarrowwidth + 8 : 0,
                b(".html5gallery-car-left-" + this.id).css({
                    display: this.options.carouselNavButton ? "block" : "none"
                }),
                b(".html5gallery-car-right-" + this.id).css({
                ...
                this.options.thumbShowNum = Math.floor((this.options.width - 4 - 4 - c) / (this.options.thumbwidth + this.options.thumbgap)),
                1 > this.options.thumbShowNum && (this.options.thumbShowNum = 1),
                this.options.thumbMaskWidth = this.options.thumbShowNum * this.options.thumbwidth + this.options.thumbShowNum * this.options.thumbgap,
                this.options.thumbTotalWidth = this.elemArray.length * this.options.thumbwidth + (this.elemArray.length - 1) * this.options.thumbgap,
                c = 0,
                this.options.thumbMaskWidth > this.options.thumbTotalWidth && (c = this.options.thumbMaskWidth / 2 - this.options.thumbTotalWidth / 2 - this.options.thumbgap / 2),
                a += ".html5gallery-thumbs-" + this.id + " { position:relative; display:block; margin-left:" + c + "px; width:" + String(this.elemArray.length * (this.options.thumbwidth + this.options.thumbgap)) + "px; top:" + Math.round(this.options.carouselHeight / 2 - this.options.thumbheight / 2) + "px; }",
                c = Math.round((this.options.width - 4 - 4) / 2 - this.options.thumbMaskWidth / 2),
                a += " .html5gallery-car-mask-" + this.id + " { position:absolute; display:block; text-align:left; overflow:hidden; left:" + c + "px; width:" + this.options.thumbMaskWidth + "px; top:0px; height:" + this.options.carouselHeight + "px;} ",
                a += " .html5gallery-tn-" + this.id + " { display:block; float:left; margin-left:" + Math.floor(this.options.thumbgap / 2) + "px; margin-right:" + Math.floor(this.options.thumbgap / 2) + "px; text-align:center; cursor:pointer; width:" + this.options.thumbwidth + "px;height:" + this.options.thumbheight + "px;overflow:hidden;}",
                this.options.thumbshadow && (a += " .html5gallery-tn-" + this.id + " { -moz-box-shadow: 0px 2px 5px #aaa; -webkit-box-shadow: 0px 2px 5px #aaa; box-shadow: 0px 2px 5px #aaa;}"),
                a += " .html5gallery-tn-selected-" + this.id + " { display:block; float:left; margin-left:" + Math.floor(this.options.thumbgap / 2) + "px; margin-right:" + Math.floor(this.options.thumbgap / 2) + "px;text-align:center; cursor:pointer; width:" + this.options.thumbwidth + "px;height:" + this.options.thumbheight + "px;overflow:hidden;}",
                this.options.thumbshadow && (a += " .html5gallery-tn-selected-" + this.id + " { -moz-box-shadow: 0px 2px 5px #aaa; -webkit-box-shadow: 0px 2px 5px #aaa; box-shadow: 0px 2px 5px #aaa;}"),
                a += " .html5gallery-tn-" + this.id + " {background-color:" + this.options.thumbimagebordercolor + ";} .html5gallery-tn-" + this.id + " { filter:alpha(opacity=" + Math.round(100 * this.options.thumbopacity) + "); opacity:" + this.options.thumbopacity + "; }  .html5gallery-tn-selected-" + this.id + " { filter:alpha(opacity=100); opacity:1; } ",
                a += " .html5gallery-tn-img-" + this.id + " {display:block; overflow:hidden; width:" + String(this.options.thumbimagewidth + 2 * this.options.thumbimageborder) + "px;height:" + String(this.options.thumbimageheight + 2 * this.options.thumbimageborder) + "px;}",
                this.options.thumbunselectedimagebordercolor && (a += " .html5gallery-tn-selected-" + this.id + " {background-color:" + this.options.thumbunselectedimagebordercolor + ";}"),
                this.options.thumbshowtitle ? (a += " .html5gallery-tn-title-" + this.id + " {display:block; overflow:hidden; float:top; height:" + this.options.thumbtitleheight + "px;width:" + String(this.options.thumbwidth - 2) + "px;}",
                a += " .html5gallery-tn-title-" + this.id + this.options.thumbtitlecss) : a += " .html5gallery-tn-title-" + this.id + " {display:none;}",
                this.carouselHighlight = function(a, c) {
                    b("#html5gallery-tn-" + this.id + "-" + a, this.$gallery).removeClass("html5gallery-tn-" + this.id).addClass("html5gallery-tn-selected-" + this.id);
                    if (this.options.thumbShowNum >= this.elemArray.length)
                        b(".html5gallery-car-left-" + this.id, this.$gallery).css({
                            "background-position": "-" + String(2 * this.options.carouselarrowwidth) + "px 0px",
            ...
            loadCarousel: function() {
                ...
                for (var d = 0; d < this.elemArray.length; d++) {
                    ...
                    b(e).on("load", function() {
                        ...
                        a.options.thumblinkintitle && (e = b(".html5gallery-tn-img-" + a.id, c),
                        e.off("click").click(function() {
                            var c = b(this).closest("html5gallery-tn-" + a.id);
                            0 < c.length && (a.onThumbClick(c.data("index")),
                            a.slideRun(c.data("index"), !0, !0))
                        }),
                        a.options.switchonmouseover && e.hover(function() {
                            b(this).click()
                        }))
            ...
            goFullscreen: function() {
                ...
                b(".html5gallery-fullscreen-box-" + this.id, this.$fullscreen).hover(function() {
                    1 < g.elemArray.length && (b(".html5gallery-fullscreen-next-" + g.id, g.$fullscreen).fadeIn(),
                    b(".html5gallery-fullscreen-prev-" + g.id, g.$fullscreen).fadeIn())
                }, function() {
                    b(".html5gallery-fullscreen-next-" + g.id, g.$fullscreen).fadeOut();
                    b(".html5gallery-fullscreen-prev-" + g.id, g.$fullscreen).fadeOut()
                });
                g.options.enabletouchswipe && (a = g.options.isAndroid && g.options.enabletouchswipeonandroid ? !0 : !1,
            ...
            calcIndex: function(a) {
                ...
                -2 == a ? (this.nextElem = this.curElem,
                this.curElem = this.prevElem,
                this.prevElem = 0 > this.curElem - 1 ? this.elemArray.length - 1 : this.curElem - 1) : -1 == a ? (this.prevElem = this.curElem,
                this.curElem = this.nextElem,
                this.nextElem = this.curElem + 1 >= this.elemArray.length ? 0 : this.curElem + 1) : 0 <= a && (this.curElem = a,
                this.prevElem = 0 > this.curElem - 1 ? this.elemArray.length - 1 : this.curElem - 1,
            ...
            slideRun: function(a, c, d, e) {
                ...
                this.calcIndex(a);
                this.isFullscreen ? (this.$fullscreen.addClass("html5gallery-fullscreen-activeslide-" + this.id + "-" + this.curElem),
                0 <= this.prevElem && this.$fullscreen.removeClass("html5gallery-fullscreen-activeslide-" + this.id + "-" + this.prevElem)) : (this.$gallery.addClass("html5gallery-activeslide-" + this.id + "-" + this.curElem),
                0 <= this.prevElem && this.$gallery.removeClass("html5gallery-activeslide-" + this.id + "-" + this.prevElem));
                ...
                this.options.socialurlforeach && this.createSocialMedia();
                !this.isFullscreen && this.options.showcarousel && (b("#html5gallery-tn-" + this.id + "-" + this.curElem, this.$gallery).removeClass("html5gallery-tn-" + this.id).addClass("html5gallery-tn-selected-" + this.id),
                !this.options.notupdatecarousel && !this.disableupdatecarousel && this.carouselHighlight(this.curElem));
                if (this.options.showtitle || this.options.lightboxshowtitle || this.options.lightboxshowdescription) {
                    ...
                    if (this.isFullscreen) {
                        ...
                        this.options.showtitle && (j = "",
                        a && (j += "<div class='html5gallery-title-text-" + this.id + "'>" + a + "</div>"),
                        this.options.showdescription && f && (j += "<div class='html5gallery-description-text-" + this.id + "'>" + f + "</div>"),
                ...
                if (!(0 > a)) {
                    ...
                    !this.options.donotuseposter && (5 == a || 6 == a || 7 == a || 8 == a || 9 == a || 10 == a || 11 == a) && !d && this.elemArray[this.curElem][12] ? (this.showingPoster = !0,
                    this.showPoster()) : (b(".html5gallery-video-play-" + this.id, l).length && b(".html5gallery-video-play-" + this.id, l).remove(),
                    1 == a ? this.showImage() : (this.options.hidetitlewhenvideoisplaying && b(".html5gallery-title-" + this.id, l).hide(),
                    5 == a || 6 == a || 7 == a || 8 == a ? this.showVideo(d, e) : 9 == a ? this.showYoutube(d) : 10 == a ? this.showVimeo(d) : 11 == a ? this.showEmbedVideo(d) : 2 == a ? this.showSWF() : 12 == a && this.showIframe()));
                    this.checkMK();
                    ...
                    if ((1 == a || this.showingPoster) && !this.isPaused && 1 < this.elemArray.length && (!this.options.loop || this.looptimes < this.options.loop))
                        e = this.elemArray[this.curElem][16] ? this.elemArray[this.curElem][16] : this.options.slideshowinterval,
                        this.firstrun && this.options.setfirstslideshowinterval && (e = this.options.firstslideshowinterval),
                        this.slideshowTimeout.setInterval(e),
                        this.slideshowTimeout.start(),
                        this.isFullscreen ? b(".html5gallery-fullscreen-timer-" + this.id, this.$fullscreen).css({
                            width: 0
                        }) : b(".html5gallery-timer-" + this.id, this.$gallery).css({
                    ...
                    this.options.loop && this.looptimes >= this.options.loop && (this.looptimes = 0,
                    this.pauseGallery());
                    a = this.elemArray[this.curElem][9];
            ...
            showImage: function() {
                ...
                b(d).on("load", function() {
                    ...
                    if (c.isFullscreen) {
                        ...
                        d = "fill" == c.options.resizemode ? Math.max(c.options.width / this.width, c.options.height / this.height) : Math.min(c.options.width / this.width, c.options.height / this.height);
                    e = Math.round(d * this.width);
                    d = Math.round(d * this.height);
                    ...
                    d.length ? (a.prepend(e),
                    a.html5boxTransition(c.id, d, e, {
            ...
            adjustFullscreen: function(a, c, d) {
                ...
                b(".html5gallery-fullscreen-elem-wrapper-" + this.id, this.$fullscreen).animate({
                    width: a,
                    height: c
                }, "slow"),
                b(".html5gallery-fullscreen-bar-" + this.id, this.$fullscreen).animate({
                    width: a + 2 * this.fullscreenMargin
                }, "slow"));
                b(".html5gallery-fullscreen-next-" + this.id, this.$fullscreen).css({
                    top: Math.round(c / 2)
            ...
            showPoster: function() {
                ...
                b(j).on("load", function() {
                    ...
                    k = d.elemArray[d.curElem][18] ? Math.min(d.elemArray[d.curElem][18], d.fullscreenHeight) : Math.min(f, d.fullscreenHeight),
                    j = Math.max(g / this.width, k / this.height),
                    j = 1 < j ? 1 : j) : (j = "fill" == d.options.resizemode ? Math.max(d.options.width / this.width, d.options.height / this.height) : Math.min(d.options.width / this.width, d.options.height / this.height),
                    g = d.options.width,
                    k = d.options.height);
                    ...
                    k.length ? (c.prepend(g),
                    c.html5boxTransition(d.id, k, g, {
                    ...
                    if (!b(".html5gallery-video-play-" + d.id, a).length)
                        b("<div class='html5gallery-video-play-" + d.id + "' style='position:absolute;display:block;cursor:pointer;top:89%;left:86%;width:64px;height:64px;margin-left:-32px;margin-top:-26px;background:url(\"" + d.options.playvideoimage + "\") no-repeat right bottom;'></div>").appendTo(c).off(d.eClick).on(d.eClick, function() {
            ...
            stopAllPlaying: function() {
                ...
                if ("undefined" !== typeof html5GalleryObjects && html5GalleryObjects && html5GalleryObjects.objects)
                    for (var a = 0; a < html5GalleryObjects.objects.length; a++)
                        if (html5GalleryObjects.objects[a].id != this.id)
                            try {
                                html5GalleryObjects.objects[a].ytPlayer && "function" == typeof html5GalleryObjects.objects[a].ytPlayer.pauseVideo && html5GalleryObjects.objects[a].ytPlayer.pauseVideo(),
                                html5GalleryObjects.objects[a].vimeoPlayer && html5GalleryObjects.objects[a].vimeoPlayer.api("pause")
                            } catch (c) {}
            },
            pauseVideo: function() {
                var a = this.elemArray[this.curElem][9];
            ...
            showVideo: function(a, c) {
                ...
                a && this.options.autoslideandplayafterfirstplayed && (this.options.autoplayvideo = !0,
                this.isPaused = !1);
                ...
                if (this.options.isIE678 || this.options.isIE9 && this.options.useflashonie9 || this.options.isIE10 && this.options.useflashonie10 || this.options.isIE11 && this.options.useflashonie11)
                    ...
                    if (this.isHTML5 = !0,
                    this.options.isFirefox || this.options.isOpera)
                        if (!this.elemArray[this.curElem][4] && !this.elemArray[this.curElem][3] && (!this.options.canplaymp4 || this.options.useflashformp4onfirefox))
                            this.isHTML5 = !1;
                if (this.isHTML5) {
                    var l = this.elemArray[this.curElem][2]
                      , g = this.elemArray[this.curElem][13];
                    if (this.options.isFirefox || this.options.isOpera)
                        this.elemArray[this.curElem][4] ? l = this.elemArray[this.curElem][4] : this.elemArray[this.curElem][3] && (l = this.elemArray[this.curElem][3]),
                        this.elemArray[this.curElem][15] ? g = this.elemArray[this.curElem][15] : this.elemArray[this.curElem][14] && (g = this.elemArray[this.curElem][14]);
                    this.embedHTML5Video(b(".html5gallery-elem-video-" + this.id, d), f, e, l, g, a, j, c)
                } else
                    j = this.elemArray[this.curElem][2],
                    "/" != j.charAt(0) && ("http:" != j.substring(0, 5) && "https:" != j.substring(0, 6)) && (j = this.options.htmlfolder + j),
                    l = "",
                    this.elemArray[this.curElem][13] && (l = this.elemArray[this.curElem][13],
                    "/" != l.charAt(0) && ("http:" != l.substring(0, 5) && "https:" != l.substring(0, 6)) && (l = this.options.htmlfolder + l)),
                    f = {
                        width: f,
                        height: e,
                    ...
                    this.elemArray[this.curElem][5] && (f.clickthrough = this.elemArray[this.curElem][5],
                    this.elemArray[this.curElem][6] && (f.clickthroughtarget = this.elemArray[this.curElem][6])),
            ...
            initYoutubeApi: function() {
                ...
                for (a = 0; a < this.elemArray.length; a++)
                    9 == this.elemArray[a][9] && -1 === this.elemArray[a][2].indexOf("youtube-nocookie.com") ? b = !0 : 10 == this.elemArray[a][9] && (d = !0);
                b && (a = document.createElement("script"),
                a.src = "https://www.youtube.com/iframe_api",
                b = document.getElementsByTagName("script")[0],
                b.parentNode.insertBefore(a, b));
                d && (a = document.createElement("script"),
                a.src = this.options.jsfolder + "froogaloop2.min.js",
                b = document.getElementsByTagName("script")[0],
                b.parentNode.insertBefore(a, b))
            },
            ...
            showYoutube: function(a) {
                ...
                var j = -1 !== f.indexOf("youtube-nocookie.com")
                  , l = this;
                if (!ASYouTubeIframeAPIReady && !j && (ASYouTubeTimeout += 100,
                3E3 > ASYouTubeTimeout)) {
                    setTimeout(function() {
                        l.showYoutube(a)
                    }, 100);
                    return
                }
                ASYouTubeIframeAPIReady && !this.options.isMobile && !this.options.isIE6 && !this.options.isIE7 && !j ? (c = this.elemArray[this.curElem][2].match(/(\?v=|\/\d\/|\/embed\/|\/v\/|\.be\/)([a-zA-Z0-9\-\_]+)/)[2],
                f = function() {}
                ,
                a && (f = function(a) {
                    a.target.playVideo()
                ...
                j = this.getYoutubeParams(this.elemArray[this.curElem][2]),
                j = b.extend({
                    html5: 1,
                ...
                this.ytPlayer = new YT.Player("html5gallery-elem-video-" + this.id,{
                    ...
                    events: {
                        ...
                        onStateChange: function(a) {
                            a.data == YT.PlayerState.ENDED && (l.onVideoEnd(),
                            l.isPaused || l.slideRun(-1))
                        }
                    }
                })) : (f = this.prepareYoutubeHref(f),
                a && (f = 0 > f.indexOf("?") ? f + "?autoplay=1" : f + "&autoplay=1"),
                f = 0 > f.indexOf("?") ? f + "?wmode=transparent&rel=0" : f + "&wmode=transparent&rel=0",
                l.options.videohidecontrols && (f += "&controls=0&showinfo=0"),
                b("#html5gallery-elem-video-" + this.id, c).html("<iframe width='" + e + "' height='" + d + "' src='" + f + "' frameborder='0' allow='autoplay' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>"));
                this.options.googleanalyticsaccount && window._gaq && window._gaq.push(["_trackEvent", "Video", "Play", this.elemArray[this.curElem][2]])
            },
            showVimeo: function(a) {
                ...
                this.isPaused = !1);
                var c = this;
                if ("function" !== typeof $f && (ASVimeoTimeout += 100,
                3E3 > ASVimeoTimeout)) {
                    setTimeout(function() {
                        c.showVimeo(a)
                    }, 100);
                ...
                "function" === typeof $f && (a && !this.options.isAndroid) && (d = b("#html5gallery_vimeo_" + this.id)[0],
                c = this,
                c.vimeoPlayer = $f(d),
                c.vimeoPlayer.addEvent("ready", function() {
            ...
            onThumbClick: function(a) {
                ...
                b(window).scrollTop(a)) : 0 <= this.options.thumbjumpposition ? b(window).scrollTop(this.options.thumbjumpposition) : (a = this.container.offset().top,
                a < b(window).scrollTop() && b(window).scrollTop(a)))
            },
            onVideoEnd: function() {
            ...
            embedHTML5Video: function(a, c, d, e, f, j, l, g) {
                var k = this;
                if ((this.options.isIE11 || this.options.isIE) && this.options.usenativehtml5controlsonie || this.options.isFirefox && this.options.usenativehtml5controlsonfirefox || this.options.isIPhone && this.options.usenativehtml5controlsoniphone || this.options.isIPad && this.options.usenativehtml5controlsonipad || this.options.isAndroid && this.options.usenativehtml5controlsonandroid)
                    this.options.nativehtml5controls = !0;
                if (this.options.isIOS || this.options.isAndroid)
                    this.options.fullscreennativecontrols = !0;
                this.options.mutevideo && (this.options.defaultvideovolume = 0);
                a.html("<div class='html5gallery-elem-video-container-" + this.id + "' style='position:relative;display:block;background-color:#5a5a50;width:100%;height:100%;'><video id='html5gallery-elem-html5-video-" + this.id + "' width='100%' height='100%'" + (this.options.nativehtml5controls && !this.options.videohidecontrols ? " controls" : "") + (this.options.html5videonodownload ? ' controlsList="nodownload"' : "") + (this.options.mutevideo ? " muted" : "") + (this.options.playsinline ? " playsinline" : "") + (this.options.loopvideo ? " loop" : "") + (this.options.donotuseposter && this.options.showhtml5videoposter && this.elemArray[this.curElem][12] ? ' poster="' + this.elemArray[this.curElem][12] + '"' : "") + ">" + (this.elemArray[this.curElem][ELEM_VTT] ? '<track default src="' + this.elemArray[this.curElem][ELEM_VTT] + '" kind="subtitles" srclang="' + this.elemArray[this.curElem][ELEM_VTTLANG] + '" label="' + this.elemArray[this.curElem][ELEM_VTTLABEL] + '">' : "") + "</video></div>");
                b("video", a).get(0).setAttribute("src", (f && this.isHd ? f : e) + (0 < l ? "#t=" + l : ""));
                !this.options.nativehtml5controls && !this.options.videohidecontrols && (b("video", a).data("src", e),
                b("video", a).data("hd", f),
                b("video", a).data("ishd", this.isHd),
                b("video", a).addHTML5VideoControls(this.options.skinfolder, this, "#html5gallery-elem-html5-video-" + this.id, !1, !1, this.options.defaultvideovolume, this.options.fullscreennativecontrols, this.options.html5videonodownload, null, this.elemArray[this.curElem][ELEM_VTT] ? !0 : !1, this.options.vttline, this.options.showsubtitlebydefault));
        ...
        this.each(function() {
            ...
            k = k || {};
            for (var c in k)
                c.toLowerCase() !== c && (k[c.toLowerCase()] = k[c],
                delete k[c]);
            if ((!b(this).data("donotinit") || k && k.forceinit) && !b(this).data("inited")) {
                ...
                var h = {
                  ...
                  , q = {
                    ...
                    titleoverlay: !1,
                    titleautohide: !1,
                    titlecss: " {color:#ffffff; font-size:12px; font-family:Arial,Helvetica,sans-serif; overflow:hidden; white-space:normal; text-align:center; padding:4px;}",
                    titlecsslink: " a {color:#ffffff;}",
                ...
                for (c = 0; c < h.length; c++)
                    this.options[h[c]] && (0 < this.options[h[c]].length && "http://" != this.options[h[c]].substring(0, 7).toLowerCase() && "https://" != this.options[h[c]].substring(0, 8).toLowerCase()) && (this.options[h[c]] = this.options.skinfolder + this.options[h[c]]);
                h = "";
                ...
                h = f.length;
                for (c = 0; 5 > c; c++)
                    f = f.slice(0, h - 9 + c) + f.slice(h - 8 + c);
                -1 != this.options.htmlfolder.indexOf(f) && (this.options.frve = !1);
                h = b(window).width();
                if (this.options.screenquery)
                    for (c in this.options.screenquery)
                        h <= this.options.screenquery[c].screenwidth && (this.options.screenquery[c].gallerywidth && (this.options.width = this.options.screenquery[c].gallerywidth),
                        this.options.screenquery[c].galleryheight && (this.options.height = this.options.screenquery[c].galleryheight),
                        this.options.screenquery[c].thumbwidth && (this.options.thumbwidth = this.options.screenquery[c].thumbwidth),
                        this.options.screenquery[c].thumbheight && (this.options.thumbheight = this.options.screenquery[c].thumbheight));
                "galleryid"in this.options ? c = this.options.galleryid : (c = H,
                H++);
    ...
    jQuery(document).ready(function() {
        jQuery.fn.html5gallery && jQuery(".html5gallery").html5gallery()
    })
}
...
function HTML5GallerySWFObjectFunc() {
    ...
    function q(a) {
        if (typeof w.addEventListener != f)
            w.addEventListener("load", a, !1);
        else if (typeof r.addEventListener != f)
        ...
        if (0 < b)
            for (var c = 0; c < b; c++) {
                ...
                if (0 < n.pv[0]) {
                    var l = e(g);
                    if (l)
                        if (a(L[c].swfVersion) && !(n.wk && 312 > n.wk))
                            d(g, !0),
                            j && (h.success = !0,
                            h.ref = x(g),
                            j(h));
    ...
    function x(a) {
        ...
        if ((a = e(a)) && "OBJECT" == a.nodeName)
            typeof a.SetVariable != f ? b = a : (a = a.getElementsByTagName(j)[0]) && (b = a);
        return b
    }
    function k() {
        return !N && a("6.0.65") && (n.win || n.mac) && !(n.wk && 312 > n.wk)
    }
    function z(a, c, d, j) {
        N = !0;
        Y = j || null;
        ...
        if (h) {
            ...
            j = "MMredirectURL=" + w.location.toString().replace(/&/g, "%26") + "&MMplayerType=" + j + "&MMdoctitle=" + r.title;
            c.flashvars = typeof c.flashvars != f ? c.flashvars + ("&" + j) : j;
            n.ie && (n.win && 4 != h.readyState) && (j = r.createElement("div"),
            d += "SWFObjectNew",
            j.setAttribute("id", d),
    ...
    function H(a, b, c) {
        ...
        if (n.wk && 312 > n.wk)
            return d;
        if (g)
            if (typeof a.id == f && (a.id = c),
            n.ie && n.win) {
                var h = "", k;
                for (k in a)
                    a[k] != Object.prototype[k] && ("data" == k.toLowerCase() ? b.movie = a[k] : "styleclass" == k.toLowerCase() ? h += ' class="' + a[k] + '"' : "classid" != k.toLowerCase() && (h += " " + k + '="' + a[k] + '"'));
                k = "";
                for (var m in b)
                ...
                for (var p in a)
                    a[p] != Object.prototype[p] && ("styleclass" == p.toLowerCase() ? m.setAttribute("class", a[p]) : "classid" != p.toLowerCase() && m.setAttribute(p, a[p]));
                for (h in b)
                    b[h] != Object.prototype[h] && "movie" != h.toLowerCase() && (a = m,
                    k = h,
                    p = b[h],
                    c = r.createElement("param"),
        ...
        if (!n.ie || !n.mac) {
            ...
            if (e) {
                ...
                if (!m || t != c)
                    ...
                    m = e.appendChild(d),
                    n.ie && (n.win && typeof r.styleSheets != f && 0 < r.styleSheets.length) && (m = r.styleSheets[r.styleSheets.length - 1]),
                    t = c;
    ...
    var f = "undefined", j = "object", l = "application/x-shockwave-flash", g = "SWFObjectExprInst", w = window, r = document, K = navigator, ba = !1, V = [function() {
        if (ba) {
            ...
            if (c) {
                ...
                (function() {
                    if (typeof c.GetVariable != f) {
                        ...
                        e && (e = e.split(" ")[1].split(","),
                        n.pv = [parseInt(e[0], 10), parseInt(e[1], 10), parseInt(e[2], 10)])
                    } else if (10 > d) {
                        d++;
                        setTimeout(arguments.callee, 10);
                        return
    ...
    ], L = [], O = [], y = [], S, A, Y, I, E = !1, N = !1, m, t, J = !0, n, P = typeof r.getElementById != f && typeof r.getElementsByTagName != f && typeof r.createElement != f, F = K.userAgent.toLowerCase(), G = K.platform.toLowerCase(), W = G ? /win/.test(G) : /win/.test(F), G = G ? /mac/.test(G) : /mac/.test(F), F = /webkit/.test(F) ? parseFloat(F.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, Q = !+"\v1", D = [0, 0, 0], B = null;
    if (typeof K.plugins != f && typeof K.plugins["Shockwave Flash"] == j) {
        if ((B = K.plugins["Shockwave Flash"].description) && !(typeof K.mimeTypes != f && K.mimeTypes[l] && !K.mimeTypes[l].enabledPlugin))
            ba = !0,
            Q = !1,
            B = B.replace(/^.*\s+(\S+\s+\S+$)/, "$1"),
            D[0] = parseInt(B.replace(/^(.*)\..*$/, "$1"), 10),
            D[1] = parseInt(B.replace(/^.*\.(.*)\s.*$/, "$1"), 10),
            D[2] = /[a-zA-Z]/.test(B) ? parseInt(B.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0
    } else if (typeof w.ActiveXObject != f)
        try {
            var T = new ActiveXObject("ShockwaveFlash.ShockwaveFlash");
            if (T && (B = T.GetVariable("$version")))
                Q = !0,
                B = B.split(" ")[1].split(","),
    ...
    n.w3 && ((typeof r.readyState != f && "complete" == r.readyState || typeof r.readyState == f && (r.getElementsByTagName("body")[0] || r.body)) && v(),
    E || (typeof r.addEventListener != f && r.addEventListener("DOMContentLoaded", v, !1),
    n.ie && n.win && (r.attachEvent("onreadystatechange", function() {
        "complete" == r.readyState && (r.detachEvent("onreadystatechange", arguments.callee),
        v())
    }),
    w == top && function() {
        if (!E) {
    ...
    return {
        ...
        embedSWF: function(b, c, e, g, h, l, m, p, q, r) {
            ...
            n.w3 && !(n.wk && 312 > n.wk) && b && c && e && g && h ? (d(c, !1),
            s(function() {
                e += "";
                g += "";
                var n = {};
                ...
                if (m && typeof m === j)
                    for (var v in m)
                        s.flashvars = typeof s.flashvars != f ? s.flashvars + ("&" + v + "=" + m[v]) : v + "=" + m[v];
                if (a(h))
                    u = H(n, s, c),
                    n.id == c && d(c, !0),
                    t.success = !0,
            ...
            if (b) {
                ...
                for (var b = b.split("&"), c = 0; c < b.length; c++)
                    if (b[c].substring(0, b[c].indexOf("=")) == a)
                        return h(b[c].substring(b[c].indexOf("=") + 1))
            }
            return ""
        },
        expressInstallCallback: function() {
            if (N) {
                var a = e(g);
                a && S && (a.parentNode.replaceChild(S, a),
                A && (d(A, !0),
                n.ie && n.win && (S.style.display = "block")),
                Y && Y(I));
                N = !1
            }
        }
...
(function() {
    for (var v = document.getElementsByTagName("script"), s = "", q = 0; q < v.length; q++)
        v[q].src && v[q].src.match(/html5gallery\.js/i) && (s = v[q].src.substr(0, v[q].src.lastIndexOf("/") + 1));
    v = !1;
    if ("undefined" == typeof jQuery)
        v = !0;
    else if (q = jQuery.fn.jquery.split("."),
    1 > q[0] || 1 == q[0] && 6 > q[1])
        v = !0;
    if (v) {
        ...
        u.readyState ? u.onreadystatechange = function() {
            if ("loaded" == u.readyState || "complete" == u.readyState)
